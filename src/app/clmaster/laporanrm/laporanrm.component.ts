...
export class laporanrmComponent implements OnInit {
  ...
  lihatkunjungan() {
    var redirectWindow = window.open(
      this.URLINVOICE +
        "clenic/report/kunjunganrm.php?tgldari=" +
        this.tgldari +
        "&kdcabang=" +
        this.kdcabang +
        "&tglsampai=" +
  ...
  lihatrekap() {
    var redirectWindow = window.open(
      this.URLINVOICE +
        "clenic/report/rekaprj.php?tgldari=" +
        this.tgldari +
        "&kdcabang=" +
        this.kdcabang +
        "&tglsampai=" +
  ...
  lihatkunjunganexcel() {
    var redirectWindow = window.open(
      this.URLINVOICE +
        "clenic/report/kunjunganrmexcel.php?tgldari=" +
        this.tgldari +
        "&kdcabang=" +
        this.kdcabang +
        "&tglsampai=" +
  ...
  lihatdiagp() {
    var redirectWindow = window.open(
      this.URLINVOICE +
        "clenic/report/diagnosapriodik.php?tgldari=" +
        this.tgldari +
        "&kdcabang=" +
        this.kdcabang +
        "&tglsampai=" +
  ...
  lihatdiagpex() {
    var redirectWindow = window.open(
      this.URLINVOICE +
        "clenic/report/diagnosapriodikex.php?tgldari=" +
        this.tgldari +
        "&kdcabang=" +
        this.kdcabang +
        "&tglsampai=" +
  ...
  lihatdiagp10() {
    var redirectWindow = window.open(
      this.URLINVOICE +
        "clenic/report/10besardiagnosa.php?tgldari=" +
        this.tgldari +
        "&kdcabang=" +
        this.kdcabang +
        "&tglsampai=" +
  ...
  lihatdiagp10ex() {
    var redirectWindow = window.open(
      this.URLINVOICE +
        "clenic/report/10besardiagnosaex.php?tgldari=" +
        this.tgldari +
        "&kdcabang=" +
        this.kdcabang +
        "&tglsampai=" +
  ...
  lihattindak10() {
    var redirectWindow = window.open(
      this.URLINVOICE +
        "clenic/report/10tindakan.php?tgldari=" +
        this.tgldari +
        "&kdcabang=" +
        this.kdcabang +
        "&tglsampai=" +
  ...
  lihattindak10ex() {
    var redirectWindow = window.open(
      this.URLINVOICE +
        "clenic/report/10tindakanex.php?tgldari=" +
        this.tgldari +
        "&kdcabang=" +
        this.kdcabang +
        "&tglsampai=" +
  ...
  lihatpasienbaru() {
    var redirectWindow = window.open(
      this.URLINVOICE +
        "clenic/report/pasienbaru.php?tgldari=" +
        this.tgldari +
        "&kdcabang=" +
        this.kdcabang +
        "&tglsampai=" +
  ...
  lihatpasienbaruex() {
    var redirectWindow = window.open(
      this.URLINVOICE +
        "clenic/report/pasienbaruex.php?tgldari=" +
        this.tgldari +
        "&kdcabang=" +
        this.kdcabang +
        "&tglsampai=" +
  ...
  lihatrjkom() {
    if (this.getDayDiff(new Date(this.tgldari), new Date(this.tglsampai)) > 7) {
      ...
      var redirectWindow = window.open(
        this.URLINVOICE +
          "clenic/report/pendapatanproduklab.php?kdcabang=" +
          this.kdcabang +
          "&tgldari=" +
          this.tgldari +
          "&tglsampai=" +
  ...
  lihatrjkomexcel() {
    if (this.getDayDiff(new Date(this.tgldari), new Date(this.tglsampai)) > 7) {
      ...
      var redirectWindow = window.open(
        this.URLINVOICE +
          "clenic/report/pendapatanproduklabexcel.php?kdcabang=" +
          this.kdcabang +
          "&tgldari=" +
          this.tgldari +
          "&tglsampai=" +
