...
import { spesialisasiRoutingModule } from './spesialisasi-routing.module';
...
@NgModule({
  ...
  declarations: [spesialisasiComponent]
})
export class spesialisasiModule { }
