...
import { mdokterprofilRoutingModule } from './mdokterprofilrouting.module';
...
@NgModule({
  ...
  declarations: [mdokterprofilComponent]
})
export class mdokterprofilModule { }
