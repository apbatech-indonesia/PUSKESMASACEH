  ...
  qtyracikm(kdtamplated,namaracik,metode,aturan,qty,
    ...
    keteranganracikm(kdtamplated,namaracik,metode,aturan,qty,
      ...
      metoderacik(kdtamplated,namaracik,metode,aturan,qty,
        ...
        hapusobat(notransaksi,kdpoli,kdpruduk,statuso,dari,kunci,no,kdcppt,nama,kdobatbpjs,kdObatSK,kdRacikan){
          const swalWithBootstrapButtons = Swal.mixin({
            customClass: {
              confirmButton: 'btn btn-success',
              cancelButton: 'btn btn-danger'
    ...
    async simpanobatsatusehat() {
      ...
      let medication: any = await this.authService.medication({
        data: {
          ...
          listObat: `${this.namaobatsatusehat} ${Math.random().toString(16).slice(2)} `
        }
      ...
      await this.authService.medicationDispense({
        data: {
            ...
            patientName: this.pasien,
            encounterId: this.idsatusehat,
            encounterDescription: "{{$randomLoremWords}}",
            practitionerId: this.idhis,
...
keteranganm:string='';
  ...
  .subscribe(
    ...
    let body ={
      ...
      "kduser":this.kduser,"kdcppt":this.notrans+this.kddokter,"stssimpan":'1',"kdcabang":this.kdcabang,"kdtamplate":'0'
    }
