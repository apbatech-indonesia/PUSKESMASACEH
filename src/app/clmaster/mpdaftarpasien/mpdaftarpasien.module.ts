...
import { MpdaftarpasienRoutingModule } from './mpdaftarpasien-routing.module';
...
@NgModule({
  ...
  declarations: [MpdaftarpasienComponent]
})
export class MpdaftarpasienModule { }
