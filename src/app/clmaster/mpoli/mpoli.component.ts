...
export class MpoliComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.authService.cekpoli().subscribe(
      (data) => {
  ...
  tmpusers: any;
  tmppuser() {
    this.authService.gudang(this.kdklinik).subscribe(
      (data) => {
        this.tmpusers = data;
      },
      (Error) => {
  ...
  cariuserx(a) {
    this.authService
      .caripoli(this.kdcabang, a.target.value)
      .subscribe((data) => {
        this.poliklinik = data;
      });
  }
  ...
  simpanlokasi() {
    ...
    if (this.idsatusehat.length > 10) {
      this.authService
        .editlokasiss(bodyss, headers, this.idsatusehat)
        .subscribe((response) => {
          ...
          this.authService.simpanlokasi(body).subscribe((response) => {
            this.toastr.success("Berhasil", "Sukses", {
              timeOut: 2000,
            });
          });
      ...
      this.authService.simpanlokasiss(bodyss, headers).subscribe((response) => {
        console.log(response);
