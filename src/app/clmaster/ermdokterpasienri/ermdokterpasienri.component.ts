...
kduser:any;
  ...
  received = [];
  sent = [];
  constructor(private WebsocketService: WebsocketService,private modalService: NgbModal,public toastr: ToastrService, private authService:ApiserviceService , private fb: FormBuilder) {
...
tampilpas:any;
  ...
  tmptotal(){
    this.authService.t_listpasienridokter(this.kdcabang,'',this.kduser)
    .subscribe(
      data => {
...
this.tampilpas = data;
  ...
  pilihpasien(norm,kdpoli
        ...
        panggil(a,b){
          this.authService.panggilantrian(a,b)
          .subscribe(
            data => {
