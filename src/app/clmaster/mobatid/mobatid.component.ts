...
@Component({
  selector: 'app-mobatid',
  templateUrl: './mobatid.component.html',
  styles: [
    `.example-container {
      display: flex;
...
export class MobatidComponent implements OnInit {
  faSearch = faSearch;
  heading = 'Master Obat';
  subheading :any;
...
public userDetailss: any;
  constructor(private modalService: NgbModal,public toastr: ToastrService, private authService:ApiserviceService , private fb: FormBuilder) {
    ...
    const datax = JSON.parse(localStorage.getItem("kdbatclenic"));
    this.userDetails=data.userData
    this.userDetailss = datax
    this.nama = this.userDetails.nama
    this.akses = this.userDetails.hakakses
this.kdklinik = this.userDetails.kdklinik;
 this.kdcabang = this.userDetails.kdcabang;

this.kdobat = this.userDetailss.kdobat;
...
if(a == '2'){
  ...
  this.authService.carisuplier('2','',this.kdcabang)
  .subscribe(
    data => {
  ...
  this.authService.carigolobat('1','')
  .subscribe(
    data => {
  ...
  this.authService.carigolobat('2','')
  .subscribe(
    data => {
...
rakinput='';
 ...
 raks(){
  this.authService.rakobat(this.kdcabang,'')
  .subscribe(
    data => {
...
carirak(a){
  this.authService.rakobat(this.kdcabang,a.target.value)
  .subscribe(
    data => {
...
carigol(a){
 ...
 this.authService.carigolobat('1',a.target.value)
 .subscribe(
   data => {
 ...
 this.authService.carigolobat('2',a.target.value)
 .subscribe(
   data => {
  ...
  caripabrikan(a){
    this.authService.carisuplier('2',a.target.value,this.kdcabang)
    .subscribe(
      data => {
...
this.showeditrak = true;
  ...
  simpanc(){
        ...
        this.authService.simpranrak(this.kdcabang,this.kdklinik,this.inrak,this.kdrak,'1').then(data =>{
...
editc(){
        ...
        this.authService.simpranrak(this.kdcabang,this.kdklinik,this.inrak,this.kdrak,'2').then(data =>{
          this.raks()
      ...
      hapus(kdobat,
        ...
        swalWithBootstrapButtons.fire({
          ...
          if (result.value) {
            ...
            let body = {
              "obat":obat,"hna":hna,"disc":disc,"ppn":ppn,"hargabeli":hargabeli,"margin":margin,
            "hargajual": hargajual,"bhp":bhp,"rakinput":'-',"supplier":'-',"pabrikan":'-',
            "golonganobat":'-',"jenisobat":'-',"zakaktif":'-',"standart":'-',
            "standartd":'-',"sedang":'-',
            "sedangd":'-',"kemasan":'-',"kemasand":'-',"kdcabang":this.kdcabang,"kdklinik":this.kdklinik,"stssimpan":'3',"kdobat":kdobat
            }
      ...
      deleterak(a,b){
        ...
        swalWithBootstrapButtons.fire({
          ...
          if (result.value) {
            ...
            this.authService.simpranrak(this.kdcabang,this.kdklinik,this.inrak,a,'3').then(data =>{
...
if(data === 200){
  ...
  this.toastr.error('Tidak Bisa di Hapus Karena Rak Sudah Di pakai', 'Eror');
  ...
  kdsup='';
     simpan2(){
      ...
      this.authService.simpansuplier(this.kdcabang,this.kdklinik,this.insup,this.inalamat,this.inhp,this.kdsup,'1').then(data =>{
        this.authService.carisuplier('1','',this.kdcabang)
        .subscribe(
          data => {
   ...
   if(data ){
    ...
    this.toastr.error('Simpan Gagal', 'Eror');
     ...
     edit2(){
      this.authService.simpansuplier(this.kdcabang,this.kdklinik,this.insup,this.inalamat,this.inhp,this.kdsup,'2').then(data =>{
        this.authService.carisuplier('1','',this.kdcabang)
        .subscribe(
          data => {
     ...
     deletesup(a,b,c,d){
      ...
      swalWithBootstrapButtons.fire({
        ...
        if (result.value) {
          ...
          this.authService.simpansuplier(this.kdcabang,this.kdklinik,b,c,d,a,'3').then(data =>{
...
this.toastr.success('Berhasil Hapus', 'Sukses', {
  ...
  this.toastr.error('Gagal Hapus Karena Sudah Di Pakai', 'Eror');
     ...
     inhpp='';
     edit3(){
      this.authService.simpanpabrikan(this.kdcabang,this.kdklinik,this.inpabrik,this.inalamatp,this.inhpp,this.kdpabrik,'2').then(data =>{
...
this.showeditpab = false;
    ...
    this.toastr.error('Simpan Gagal', 'Eror');
     ...
     simpan3(){
      this.authService.simpanpabrikan(this.kdcabang,this.kdklinik,this.inpabrik,this.inalamatp,this.inhpp,this.kdpabrik,'1').then(data =>{
   ...
   if(data ){
     ...
     deletepab(kdpabrikan,nama,alamat,hp){
      ...
      swalWithBootstrapButtons.fire({
        ...
        if (result.value) {
          ...
          this.authService.simpanpabrikan(this.kdcabang,this.kdklinik,this.inpabrik,this.inalamatp,this.inhpp,kdpabrikan,'3').then(data =>{
    ...
    this.toastr.error('Tidak Bisa di Hapus Karena  Sudah Di pakai', 'Eror');
...
simpan(){
  ...
  "sedangd":this.sedangd,"kemasan":this.kemasan,"kemasand":this.kemasand,"kdcabang":this.kdcabang,"kdklinik":this.kdklinik,"stssimpan":'1',"kdobat":this.kdobat
  }
...
tmpobat(){
  this.authService.obatbyid(this.kdcabang,this.kdobat)
  .subscribe(
    data => {
    ...
    for(let x of data){
      ...
      this.kdobat = x.kdobat;
      this.obat =  x.obat,
      this.golonganobat =  x.golonganobat,
      this.jenisobat =  x.jenisobat,
      this.hna =  x.hna,
      this.disc =  x.disc,
      this.ppn =  x.ppn,
      this.hargabeli =  x.hargabeli,
      this.margin =  x.margin,
      this.hargajual =  x.hargajual,
      this.bhp = x.bhp,
      this.rakinput =  x.raksimpan,
      this.supplier =  x.kdsuplier,
      this.pabrikan =  x.kdpabrikan,
      this.zakaktif =  x.zakaktif,
      this.standart= x.standart,
     this.standartd= x.standartd,
     this.sedang=  x.sedang,
     this.sedangd=  x.sedangd,
      this.kemasan =   x.kemasan,
     this.kemasand =  x.kemasand,
      this.kdklinik =  x.kdklinik,
      this.kdcabang =  x.kdcabang,
     this.pabrikand=  x.nama,
      this.supplierd=  x.sup,
     this.jenisobatd =  x.jenis,
    this.golonganobatd =  x.golongan
    }
...
lihatstok(content,a){
  ...
  this.authService.stokobat(this.kdcabang,a)
  .subscribe(
    data => {
