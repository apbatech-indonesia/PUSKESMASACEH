...
@Component({
  selector: 'app-adjustobat',
  templateUrl: './adjustobat.component.html',
  styles: [
...
export class adjustobatComponent implements OnInit {
...
onobat(a){
  ...
  this.authService.obatbykodestok(this.kdcabang,this.nmobat,this.kdgudang)
  .subscribe(
    data => {
...
trxmutasix(){
  this.authService.listadjustd(this.kdcabang,this.nomutasi)
  .subscribe(
    data => {
...
onqty(a){
  if(this.nomutasi === ''){
    this.toastr.error('No Adjust Kosong anda belum create no Adjust atau  belum memilih list Adjust', 'Eror');
  }else{
    ...
    //     let body={
    //   "nomutasi":this.nomutasi,"kdsuplier":this.kdsuplier,"kdgudang":this.kdgudang,"keterangan":this.keterangan,
    //   "kdobat":this.nmobat,"qty":a.target.value,"kdcabang":this.kdcabang,"stssimpan":'2',"kdklinik":this.kdklinik
    // }
...
// $stokreal = $data->stokreal;
    ...
    let body={
      "nomutasi":this.nomutasi,"kdgudang":this.kdgudang,"keterangan":this.keterangan,"kdobat":this.nmobat,"stokawal":this.stok,"stokreal":a.target.value,
     "kdcabang":this.kdcabang,"stssimpan":'2',"kdklinik":this.kdklinik,"user":this.username
    }
  

  
    // this.authService.simpanadjust(body)
  ...
  setTimeout(() => {
    ...
    this.authService.obatbykodestok(this.kdcabang,'','')
    .subscribe(
      data => {
...
keterangan:any;
    ...
    tambah(){
      ...
      let body={
        "noadjust":this.nomutasi,"kdgudang":this.kdgudang,"keterangan":this.keterangan,
...
.subscribe(response => {
  ...
  if(response ){
      ...
      swalWithBootstrapButtons.fire({
        ...
        if (result.value) {
          ...
          if(data.length){
            ...
            let body={
              "nomutasi":this.nomutasi,
             "kdcabang":this.kdcabang,"stssimpan":'4',"kdklinik":this.kdklinik
            }
    ...
    hapusobat(noadjust,nomor,kdobat,stokawal,stokreal,obat,standart){
      ...
      swalWithBootstrapButtons.fire({
        ...
        if (result.value) {
          ...
          let body={"nomutasi":noadjust,"nomor":nomor,"kdobat":kdobat,"stokreal":stokreal,"stokawal":stokawal,
          "kdcabang":this.kdcabang,"kdklinik":this.kdklinik,"stssimpan":'3',"kdgudang":this.kdgudang}
...
console.log(body)
  ...
  ktglrad(){
    this.tmpbeli()
  //   this.authService.caripembelian(this.kdcabang,this.tglp,this.caripas,'','')
  //   .subscribe(
  //     data => {
  ...
  //   )
    ...
    caripass(a){
      this.authService.caripembelian(this.kdcabang,this.tglp,this.caripas,a.target.value,'')
      .subscribe(
        data => {
          this.totalpasenlist = data.length
    this.tbeli = data;
    ...
    caripas='1';
tmpbeli(){
  this.authService.listadjust(this.kdcabang,this.tglp,'')
  .subscribe(
    data => {
      this.totalpasenlist = data.length
this.tbeli = data;
...
pilihpasien(noadjust,tgl,kdgudang,keterangan)
  {


    this.nomutasi = noadjust;
    this.tglp = tgl;
