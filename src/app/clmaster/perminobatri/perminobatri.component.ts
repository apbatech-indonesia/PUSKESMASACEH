...
@Component({
  selector: 'app-perminobatri',
  templateUrl: './perminobatri.component.html',
  styles: [
...
export class perminobatriComponent implements OnInit {
...
this.kdcpptangka =  this.userDetailss.kdcpptangka
...
caribhp(a){
  ...
  if(a.target.value.length){
    this.authService.hasiltamplatebhp(this.kdcabang,a.target.value)
    .subscribe(
      data => {
...
tlistobatr:any;
tmpnonr(){
  this.authService.obatnonracik(this.kdcabang,this.notrans,this.notrans+this.kddokter+this.kdcpptangka)
  .subscribe(
    data => {
...
this.tlistobatn = data;
  ...
  this.authService.obatracik(this.kdcabang,this.notrans,this.notrans+this.kddokter+this.kdcpptangka,this.nomorracik)
  .subscribe(
    data => {
...
this.tlistobatr = data;
  ...
  this.authService.tmpbhp(this.kdcabang,this.notrans,this.notrans+this.kddokter+this.kdcpptangka)
  .subscribe(
    data => {
...
pilihobattamb(kdtamplated,nama,status){
  ...
  swalWithBootstrapButtons.fire({
    ...
    if (result.value) {
      ...
      let body={
        "kdkostumerd":this.kdkostumerd,"norm":this.norm,"kdpoli":this.kdpoli,"kddokter":this.kddokter,"kduser":this.kduser,"kdcppt":this.notrans+this.kddokter+this.kdcpptangka,
        "stssimpan":'1',"kdcabang":this.kdcabang,"notransaksi":this.notrans,"status":status,"kdtamplated":kdtamplated
       }
    
       this.authService.copyterapitamplateb(body)
       .subscribe(response => {
  ...
  Swal.fire({
    ...
    preConfirm: (value) => {
      if (!value) {
        ...
        let body={
          "aturan":value,"no":no,"norm":norm,"kdpoli":kdpoli,"kddokter":kddokter,"kduser":this.kduser,"kdcppt":notransaksi+kddokter+this.kdcpptangka,
  ...
  Swal.fire({
    ...
    preConfirm: (value) => {
      if (!value) {
        ...
        let body={
          "qty":value,"no":no,"norm":norm,"kdpoli":kdpoli,"kddokter":kddokter,"kduser":this.kduser,"kdcppt":notransaksi+kddokter+this.kdcpptangka,
  ...
  Swal.fire({
    ...
    preConfirm: (value) => {
      if (!value) {
        ...
        let body={
          "keterangan":value,"no":no,"norm":norm,"kdpoli":kdpoli,"kddokter":kddokter,"kduser":this.kduser,"kdcppt":notransaksi+kddokter+this.kdcpptangka,
      ...
      metoderacik(kdtamplated,namaracik,metode,aturan,qty,
        ...
        hapusobatt(a){
          ...
          swalWithBootstrapButtons.fire({
            ...
            "statuso":'MRacik',"dari":'MObat',"kunci":'0',"no":'',"kdcppt":this.notrans+this.kddokter+this.kdcpptangka,"kdcabang":this.kdcabang,"stssimpan":'2'
        ...
        tambahobatedit(){
          ...
          if(x < this.qtyk){
            ...
            this.toastr.error('Stok Tidak Menyukupi untuk '+this.jmlhari+' Hari,Silahkan Sesuikan', 'Eror');
                  
          
          }else{
            let body={
              "nmobat":this.nmobat,"aturan":this.aturan,"qtyk":this.qtyk,
              ...
              "kdcppt":this.notrans+this.kddokter+this.kdcpptangka,
        ...
        tambahobatal(){
          ...
          if(this.Stok < this.qtyk){
            ...
            let body={
              "nmobat":this.nmobata,"aturan":this.aturan,"qtyk":this.qtyk,
              "keterangan":this.keterangan,
              "notrans":this.notrans,"norm":this.norm,"kddokter":this.kddokter,
              "kdpoli":this.kdpoli,"kdobat":this.nmobat,"statuso":'BHP',"dari":'Obat',
              "kduser":this.username,"kdcabang":this.kdcabang,
              "kdcppt":this.notrans+this.kddokter+this.kdcpptangka,
...
if(data.length){
 ...
 if(x.stok <= 0){
  ...
  setTimeout(() => {
    this.authService.frekuensiobat(this.kdcp,this.kdbs)
    .subscribe(
      data => {
        ...
        if(data.length){
          ...
          this.authService.tamplatesignano('1')
          .subscribe(
            data => {
              this.showfrekuensi =  true;
              this.tfrekuensi = data;
...
Stoka:any;
  ...
  this.authService.obatermbyid(this.kdcabang,this.nmobata)
  .subscribe(
    data => {
...
showjmlpakai:boolean;
    ...
    pilihfrek(a){
      ...
      setTimeout(() => {
        this.authService.jmlobathari(this.kdcp,this.kdbs)
        .subscribe(
          data => {
      ...
      this.jmlpakaii.nativeElement.focus()
              ...
              this.authService.tamplatesignano('2')
              .subscribe(
                data => {
                  this.showjmlpakai = true;
...
showjmlhari:boolean;
    ...
    pilihjmlpakai(a){
      ...
      setTimeout(() => {
        this.authService.signa(this.kdcp,this.kdbs)
        .subscribe(
          data => {
            ...
            this.tsigna = data;
             ...
             this.aturani.nativeElement.focus()
              ...
              this.authService.tamplatesignano('3')
              .subscribe(
                data => {
                  this.tsigna = data;
                  this.showsigna = true
...
keteranganm:string='';
    ...
    "kduser":this.username,"kdcabang":this.kdcabang,
    "kdcppt":this.notrans+this.kddokter+this.kdcpptangka,"stssimpan":'2',"kdkostumerd":this.kdkostumerd,"cpptdari":this.cpptdari
      }
    ...
    verifracik(){
      let body={
    "nmobat":this.namaracikm,"aturan":this.aturanm,"qtyk":this.qtykm,
    "keterangan":this.keteranganm,"noracik":this.nomorracik,
    "notrans":this.notrans,"norm":this.norm,"kddokter":this.kddokter,
    "metode":this.metode,"kdpoli":this.kdpoli,"kdobat":this.namaracikm,
    "statuso":'MRacik',"dari":'MObat',"kduser":this.username,
    "kdcabang":this.kdcabang,"kdcppt":this.notrans+this.kddokter+this.kdcpptangka,"stssimpan":'3',
  ...
  .subscribe(
    ...
    let body ={
      ...
      "kduser":this.kduser,"kdcppt":this.notrans+this.kddokter+this.kdcpptangka,"stssimpan":'1',"kdcabang":this.kdcabang,"kdtamplate":'0'
    }
...
qtydulu:any;
    ...
    editobat(kdpruduk,nama,qty,keterangan,signa,hari,frekuensi,jmlpakai,no){
this.qtyk = qty;
this.qtydulu = qty;
...
kshowracik(kdtamplated,namaracik,metode,aturan,qty,
  keterangan,notransaksi,kdpoli){
