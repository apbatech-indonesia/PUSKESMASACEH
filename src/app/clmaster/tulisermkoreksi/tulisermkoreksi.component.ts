...
@Component({
  selector: 'app-tulisermkoreksi',
  templateUrl: './tulisermkoreksi.component.html',
  styles: [
...
export class tulisermkoreksiComponent implements OnInit {
...
hostName: string;
URLINVOICE:string
  constructor(public hots:SampleService,private route: ActivatedRoute,private modalService: NgbModal,public toastr: ToastrService, private authService:ApiserviceService , private fb: FormBuilder,private domSanitizer: DomSanitizer) {
...
lihatrad(notrans,kdcabang,kdproduk){
  this.monitoringshowcontentx = true
  console.log(notrans)
  // hasilrad.php?notransaksi=LJ-TR11220607-002&kdcabang=002&kdproduk=TRD118
