...
@Component({
  selector: 'app-laporanri',
  templateUrl: './laporanri.component.html',
  styles: [
    `.example-container {
      display: flex;
...
export class laporanriComponent implements OnInit {
...
if(a === 'Kunjungan Rawat Jalan'){
  this.tmp()
}else if(a === 'Pendapatan Rawat Inap'){
  this.tmp()
}else if(a === 'Pendapatan RI/Konsumen'){
  this.tmp()
  this.tmpkonsumen()
...
lihatrj(){
  var redirectWindow = window.open(this.URLINVOICE+'clenic/report/pendapatanri.php?kdcabang='+this.kdcabang+'&username='+'&tgldari='+this.tgldari+'&tglsampai='+this.tglsampai+'&status='+this.kdklinik+'&kdpoli='+this.kdklinik, '_blank','location=no,toolbar=no,height='+screen.height+',width='+screen.width+',scrollbars=yes,status=yes');
      redirectWindow.location;
 }
 ...
 lihatrjexcel(){
  var redirectWindow = window.open(this.URLINVOICE+'clenic/report/pendapatanriexcel.php?kdcabang='+this.kdcabang+'&username='+'&tgldari='+this.tgldari+'&tglsampai='+this.tglsampai+'&status='+this.kdklinik+'&kdpoli='+this.kdklinik, '_blank','location=no,toolbar=no,height='+screen.height+',width='+screen.width+',scrollbars=yes,status=yes');
      redirectWindow.location;
 }
 ...
 lihatrjkondok(){
  var redirectWindow = window.open(this.URLINVOICE+'clenic/report/jasadokterrj.php?kdcabang='+this.kdcabang+'&tgldari='+this.tgldari+'&tglsampai='+this.tglsampai+'&status='+this.kddokter, '_blank','location=no,toolbar=no,height='+screen.height+',width='+screen.width+',scrollbars=yes,status=yes');
  redirectWindow.location;
 }

 lihatrjkondokexcel(){
  var redirectWindow = window.open(this.URLINVOICE+'clenic/report/jasadokterrjexcel.php?kdcabang='+this.kdcabang+'&tgldari='+this.tgldari+'&tglsampai='+this.tglsampai+'&status='+this.kddokter, '_blank','location=no,toolbar=no,height='+screen.height+',width='+screen.width+',scrollbars=yes,status=yes');
  redirectWindow.location;
 }
 ...
 lihatrjkom(){
  var redirectWindow = window.open(this.URLINVOICE+'clenic/report/jasakomponen.php?kdcabang='+this.kdcabang+'&tgldari='+this.tgldari+'&tglsampai='+this.tglsampai+'&status='+this.kdkom, '_blank','location=no,toolbar=no,height=570,width=1000,scrollbars=yes,status=yes');
  redirectWindow.location;
 }

 lihatrjkomexcel(){
  var redirectWindow = window.open(this.URLINVOICE+'clenic/report/jasakomponenexcel.php?kdcabang='+this.kdcabang+'&tgldari='+this.tgldari+'&tglsampai='+this.tglsampai+'&status='+this.kdkom, '_blank','location=no,toolbar=no,height=570,width=1000,scrollbars=yes,status=yes');
  redirectWindow.location;
 }
 lihatrjkomx(){
  var redirectWindow = window.open(this.URLINVOICE+'clenic/report/pendapatantf.php?kdcabang='+this.kdcabang+'&tgldari='+this.tgldari+'&tglsampai='+this.tglsampai, '_blank','location=no,toolbar=no,height=570,width=1000,scrollbars=yes,status=yes');
  redirectWindow.location;
 }
