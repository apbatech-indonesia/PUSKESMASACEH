...
resepbaru:any='';
  ...
  this.kdbapak = a.node.key
    this.authService.tarifdetail(this.kdcabang,'2','',a.node.key,'LAB')
    .subscribe(
      data => {
...
tmptarif(){
  this.authService.listtariftree(this.kdcabang,'LAB',this.kdtarif)
  .subscribe(
    data => {
...
totalpasien:any;
ktglrad(){
  this.authService.pasienantrianlab(this.kdcabang,this.caripas,'',this.tglp,'tanggal')
  .subscribe(
    data => {
...
this.totalpasien = data.length
  ...
  openLarge(content) {
    ...
    this.authService.pasienantrianlab(this.kdcabang,this.caripas,'',this.tglp,this.statuscari)
    .subscribe(
      data => {
...
this.totalpasien = data.length
  ...
  caripass(a){
    ...
    this.authService.pasienantrianlab(this.kdcabang,this.caripas,a.target.value,this.tglp,this.statuscari)
    .subscribe(
      data => {
...
kdcppt:any;
  ...
  pilihpasien(norm,kdpoli
        ...
        this.shotombol = true
          ...
          this.authService.listintruksilab(this.kdcabang,this.notransaksi,'LABORAT',kdcppt)
          .subscribe(
           data => {
          ...
          this.tlistrad = data;
           ...
           this.authService.keteranganklinis(this.kdcabang,this.notransaksi,'LABORAT',kdcppt)
           .subscribe(
             data => {
 ...
 this.keteranganakhirrad = x.keterangan
           ...
           this.authService.doktertunjang(this.kdcabang,'lab')
    .subscribe(
      data => {
...
tmptrans(){
  ...
  this.authService.listtrxrjpenunjang(this.kdcabang,this.notransaksi,this.namatrx,'1')
  .subscribe(
    data => {
...
caritarif(a){
  this.authService.tarifdetail(this.kdcabang,'2',a.target.value,this.kdbapak,'LAB')
  .subscribe(
    data => {
  ...
  swalWithBootstrapButtons.fire({
    ...
    if (result.value) {
      ...
      let body ={"user":this.username,
        "notrans":this.notransaksi,"notransri":this.notransaksiri,"kdtf":'5',"nmtf":'Transfer Laborat',"kdpoli":this.kdpoli,"qty":'1',"harga":this.totalrjsaja,"debet":0,
        "kridit":this.totalrjsaja,"jenistransaksi":'KR',"tarifasli":this.totalrjsaja,"disc":0,"nofaktur":this.nofaktur,
        "kdcabang":this.kdcabang,"kdklinik":this.kdklinik,"stssimpan":'1',"kdkostumerd":this.kdkostumerd,"norm":this.norm
      }
...
let body={"user":this.username,"kdprodukbayar":this.kdprodukbayar,"nofaktur":this.nofaktur,
  ...
  "tgldari":this.tgldari,"bulat":this.pembulatanrj
}
...
let body={"user":this.username,"kdprodukbayar":this.kdprodukbayar,"netto":this.netto,"tgldari":this.tgldari,
  "produkbayar":this.produkbayar,"totalrjsaja":this.totalrjsaja,"norm":this.norm,"kurangbayar":this.kurangbayari,"totalrjsajaasli":this.totaltagihan,
          ...
          if(a === 'KR'){
            ...
            swalWithBootstrapButtons.fire({
              ...
              if (result.value) {
                ...
                let body={"user":this.username,"kdprodukbayar":'1',"netto":this.netto,"tgldari":this.tgldari,
...
this.tlistrujuk = data;
 ...
 lihathasil(){
  this.authService.tamplatelab(this.kdcabang,this.notransaksi,this.jeniskelamin)
  .subscribe(
    data => {
...
this.showloading= true
  setTimeout(() => {
    let body = {
      "notrans":this.notransaksi,"norm":this.norm,"keteranganx":this.keteranganakhir,"kdcabang":this.kdcabang,"statusx":'1',"stssimpan":'2'}
  
  
  
    this.authService.simpanhasilalbx(body)
    .subscribe(response => {
    ...
    .subscribe(response => {
      ...
      if(response){
        ...
        setTimeout(() => {
          ...
          this.authService.selesaiverif(this.kdcabang,response,'3')
          .subscribe(
            data => {
