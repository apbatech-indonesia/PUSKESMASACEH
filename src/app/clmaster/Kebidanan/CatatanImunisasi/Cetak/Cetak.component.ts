...
export class CetakComponent implements OnInit {
  ...
  initPage(){
    ...
    this.page.nik = localStorage.getItem('nik') != 'undefined' ? localStorage.getItem('nik') : '';
    this.page.nama_bayi = localStorage.getItem('nama_bayi') != 'undefined' ? localStorage.getItem('nama_bayi') : '';
