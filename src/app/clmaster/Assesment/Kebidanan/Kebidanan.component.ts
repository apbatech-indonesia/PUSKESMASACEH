...
export class KebidananComponent implements OnInit {
  ...
  simpanKebidanan() {
    ...
    let body = {
      ...
      tanggal_assesment: this.datepipe.transform(
        this.tanggal_assesment,
        "yyyy-MM-dd"
      ),
      ...
      palpasi_leopold_4_penurunan_teraba:
        this.palpasi_leopold_4_penurunan_teraba,
      djj: this.djj,
        ...
        this.kebidananService.updateKebidanan(body).subscribe(
          (data: any) => {
            ...
            if (data.success == true) {
              this.ambilSemuaNoTransaksiPerNoRM();
              this.toastr.success(
                "Assesmen kebidanan sudah diupdate",
                "Sukses",
                {
                  timeOut: 2000,
                }
  ...
  ambilDataKebidanan() {
    ...
    this.kebidananService
      .getKebidananAssesmentByNoTransaksiNoRM(this.no_rm, this.no_transaksi)
      .subscribe(
        (data: any) => {
          // console.log(data);
          ...
          if (this.asesmentKebidanan.asesmen_informasi[0]) {
            ...
            this.pasangAssesmentInformasi(
              this.asesmentKebidanan.asesmen_informasi[0]
            );
            this.pasangDataKehamilan(this.asesmentKebidanan.data_kehamilan[0]);
            this.pasangEliminasiAssesment(
              this.asesmentKebidanan.eliminasi_asesmen[0]
            );
            this.pasangMasalahDiagnosisAssesment(
              this.asesmentKebidanan.masalah_diagnosis_kebidanan[0]
            );
            this.pasangSosialBudaya(this.asesmentKebidanan.sosial_budaya[0]);
            this.pasangRiwayatObsetri(
              this.asesmentKebidanan.riwayat_obstetri[0]
            );
            this.pasangRiwayatKesehatan(
              this.asesmentKebidanan.riwayat_kesehatan[0]
            );
            this.pasangPemeriksaanFisik(
              this.asesmentKebidanan.pemeriksaan_fisik[0]
            );
            this.pasangPengkajianNyeri(
              this.asesmentKebidanan.pengkajian_nyeri[0]
            );
            this.pasangNutrisiAssesment(
              this.asesmentKebidanan.nutrisi_asesmen[0]
            );
            this.pasangAktifitasDanIstirahat(
              this.asesmentKebidanan.aktivitas_dan_istirahat[0]
            );
    ...
    if (
      ...
      this.kebidananService.simpanRiwayatPengobatan(body).subscribe(
        (data: any) => {
          ...
          if (data.success == true) {
            this.toastr.success(
              "Data Riwayat Pengobatan sudah dibuat",
              "Sukses",
              {
                timeOut: 2000,
              }
  ...
  openModalRiwayatPengobatan(content) {
    this.modalService
      .open(content, { ariaLabelledBy: "modal-riwayat-pengobatan" })
      .result.then(
        (result) => {
          this.closeResultModalRiwayatPengobatan = `Closed with: ${result}`;
        },
        (reason) => {
          this.closeResultModalRiwayatPengobatan = `Dismissed ${this.getDismissReasonModalRiwayatPengobatan(
            reason
          )}`;
        }
      );
  ...
  openModalHapusRiwayatPengobatan(content, id) {
    ...
    this.modalService
      .open(content, { ariaLabelledBy: "modal-hapus-riwayat-pengobatan" })
      .result.then(
        (result) => {
          this.closeResultModalHapusRiwayatPengobatan = `Closed with: ${result}`;
        },
        (reason) => {
          this.closeResultModalHapusRiwayatPengobatan = `Dismissed ${this.getDismissReasonModalHapusRiwayatPengobatan(
            reason
          )}`;
        }
      );
  ...
  periksaGolonganDarahIbu() {
    if (this.regexGolonganDarahIbu.invalid) {
      this.toastr.error(
        "Harap isi golongan darah menggunakan karakter",
        "Error",
        {
          timeOut: 2000,
        }
    ...
    if (
      ...
      this.kebidananService.simpanRiwayatKehamilan(body).subscribe(
        (data: any) => {
          ...
          if (data.success == true) {
            this.toastr.success(
              "Data Riwayat Kehamilan sudah dibuat",
              "Sukses",
              {
                timeOut: 2000,
              }
  ...
  openModalRiwayatKehamilan(content) {
    this.modalService
      .open(content, { ariaLabelledBy: "modal-riwayat-kehamilan" })
      .result.then(
        (result) => {
          this.closeResultModalRiwayatKehamilan = `Closed with: ${result}`;
        },
        (reason) => {
          this.closeResultModalRiwayatKehamilan = `Dismissed ${this.getDismissReasonModalRiwayatKehamilan(
            reason
          )}`;
        }
      );
  ...
  openModalHapusRiwayatKehamilan(content, id) {
    ...
    this.modalService
      .open(content, { ariaLabelledBy: "modal-hapus-riwayat-kehamilan" })
      .result.then(
        (result) => {
          this.closeResultModalHapusRiwayatKehamilan = `Closed with: ${result}`;
        },
        (reason) => {
          this.closeResultModalHapusRiwayatKehamilan = `Dismissed ${this.getDismissReasonModalHapusRiwayatKehamilan(
            reason
          )}`;
        }
      );
  ...
  pasangDataKehamilan(nilai) {
    ...
    this.palpasi_leopold_1_fundus_teraba =
      nilai.palpasi_leopold_1_fundus_teraba;
    ...
    this.palpasi_leopold_4_penurunan_teraba =
      nilai.palpasi_leopold_4_penurunan_teraba;
    this.djj = nilai.djj;
  ...
  pasangRiwayatObsetri(nilai) {
    ...
    this.kontrasepsi_yang_pernah_digunakan =
      nilai.kontrasepsi_yang_pernah_digunakan;
  ...
  pasangRiwayatKesehatan(nilai) {
    ...
    this.riwayat_pengobatan_saat_dirumah =
      nilai.riwayat_pengobatan_saat_dirumah;
    this.jenis_riwayat_penyakit_diderita =
      nilai.jenis_riwayat_penyakit_diderita;
    ...
    this.alasan_bersedia_transfusi_darah =
      nilai.alasan_bersedia_transfusi_darah;
  ...
  pasangNutrisiAssesment(nilai) {
    ...
    this.penjelasan_perubahan_berat_badan =
      nilai.penjelasan_perubahan_berat_badan;
  ...
  pasangDisabledPerubahanBeratBadan() {
    if (
      this.perubahan_berat_badan == "Penurunan" ||
      this.perubahan_berat_badan == "Kenaikan"
    ) {
  ...
  pasangDisabledBuangAirBesar() {
    if (
      this.buang_air_besar == "Konstipasi" ||
      this.buang_air_besar == "Diare" ||
      this.buang_air_besar == "Lainnya"
    ) {
  ...
  pasangNilaiGCS() {
    this.kesadaran_gcs =
      Number(this.kesadaran_e) +
      Number(this.kesadaran_m) +
      Number(this.kesadaran_v);
  }
