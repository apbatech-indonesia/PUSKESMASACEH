...
export class AssesmentAnakService {
  ...
  simpan(Objek: Object): Observable<Object>  {
    return this.http.post<Object>(this.baseUrl + '/api/asesmen-anak/create', Objek,  { headers: this.httpOptions['headers'] } )
      .pipe(
  ...
  update(Objek: Object): Observable<Object>  {
    return this.http.post<Object>(this.baseUrl + '/api/asesmen-anak/update', Objek,  { headers: this.httpOptions['headers'] } )
      .pipe(
        catchError(this.handleError('Error Ketika Mendapatkan Data', Objek))
      );
  }
  ...
  getAsesmenAnakByNoTrNoRM(no_rm: any, no_transaksi: any): Observable<any> {
    return this.http.get<any>(this.baseUrl + '/api/asesmen-anak/show/' + no_rm + '/' + no_transaksi, { headers: this.httpOptions['headers'] } );
  }
