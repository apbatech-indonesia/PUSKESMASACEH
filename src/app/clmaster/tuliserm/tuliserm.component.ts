import { Component, ElementRef, OnInit, ViewChild, inject, Type } from '@angular/core';
...
listStatusMental: string[] = ['Orientasi Baik', 'Disorientasi', 'Gelisah', 'Tidak Respon'];
listResponEmosi: string[] = ['Tenang', 'Takut', 'Tegang', 'Marah', 'Sedih', 'Gelisah'];
...
myDatedaf = new Date();
  ...
  constructor(
    ...
    public chatService:ChatService,private appComponent : AppComponent,public hots:SampleService,private router: Router,private route: ActivatedRoute,private modalService: NgbModal,public toastr: ToastrService, private authService:ApiserviceService , private fb: FormBuilder,private domSanitizer: DomSanitizer,) {
  ...
  this.authService.getDetailDataKajianAwal(noRm, noTransaksi).subscribe(
      (data: any) => {
          if(!data.success) {
            ...
            if(dataRes.penurunan_berat_badan  === this.listOpsiPenurunanBB[2] && (dataRes.jumlah_penurunan !== null)) {
...
status =false;
  ...
  this.authService.statuspulang(status)
  .subscribe(
    data => {
...
idpasien:any='';
  ...
  tampildata(){
    ...
    this.authService.cekpasienlamadanbaru(this.norm,this.kdcabang)
    .subscribe(
      data => {
...
thasillab:any;
  ...
  lihathd(){
    ...
    var redirectWindow = window.open('https://emrefamedika.clenicapp.com/frontend/#/masuk/'+this.notransaksi+'/'+this.norm+'/'+this.username+'/'+this.nama+'/'+this.akses+'/'+this.kdcabang+'/'+this.password, '_blank','location=no,toolbar=no,height='+screen.height+',width='+screen.width+',scrollbars=yes,status=yes');
...
this.authService.simpadiagnosass(body,headers)
.subscribe(response => {
  ...
  let body ={
   "stssimpan":'3',"notransaksi":this.notransaksi,"iddiagnosa":response.id
  
   }
   this.iddiagnosa = response.id

   this.authService.simpantoken(body)
   .subscribe(response => {
            ...
            swalWithBootstrapButtons.fire({
              ...
              if (result.value) {
                ...
                if(this.akses === 'Perawat'){
                  ...
                  this.toastr.error("Gagal simpan : "+response.response.field+response.response.message, 'Eror');
...
dari = '0';
 ...
 let body={"alergi":this.alergi,"dari":dari,"subjekp":this.subjekp,
          ...
          "rwytp":this.rwtp,"gigi":this.gigi,"tb":this.tb,"hakakses":this.akses,"tglkontrol":this.myDatekon,
...
diagnourut:any;
    ...
    nodeSelectx(event){
      ...
      if(event.node.harga == 0){
        ...
        "kdproduk":event.node.key,"produk":event.node.label,"kdpoli":'rad',"qty":'1',"harga":event.node.harga,"debet":event.node.harga,"kdcppt":this.notrans+this.kddokter,
       ...
       .subscribe(response => {
        ...
        nodeSelect(event) {
          ...
          let body ={"kduser":this.username,"norm":this.norm,"dari":'LABORAT',"kdkostumerd":this.kdkostumerd,
           "kdproduk":event.node.key,"produk":event.node.label,"kdpoli":'lab',"qty":'1',"harga":event.node.harga,"debet":event.node.harga,"kdcppt":this.notrans+this.kddokter,
            "kridit":0,"jenistransaksi":'DB',"tarifasli":event.node.harga,"nofaktur":this.notrans,
            "kdcabang":this.kdcabang,"kddokter":this.kddokter,"stssimpan":'1',"tglminta":this.myDatelab
          }
...
hapustarifrad(kdpruduk,kdpoli,notransaksi,nomor,kdcppt,nama){
 ...
 verifikasirad(){
  ...
  "kdcppt":this.notrans+this.kddokter,
   ...
   "kdcabang":this.kdcabang,"kddokter":this.kddokter,"stssimpan":'3',"kdklinik":this.kdklinik,'sts':'rad'
 }
     ...
     this.toastr.error('Simpan  Gagal', 'Eror');
      ...
      verifikasi(){
        ...
        "kdcppt":this.notrans+this.kddokter,
         ...
         "kdcabang":this.kdcabang,"kddokter":this.kddokter,"stssimpan":'3',"kdklinik":this.kdklinik,'sts':'lab'
       }
            ...
            trujuk:any;
              ...
              for(let x of data){
               ...
               odon(){
                ...
                var redirectWindow = window.open(this.URLINVOICE+'clenic/report/odo/odo/odontogram.php?kdcabang='+this.kdcabang+'&norm='+this.norm+'&notrans='+this.notransaksi+'&kddokter='+this.kddokter, '_blank','location=no,toolbar=no,height='+screen.height+',width='+screen.width+',scrollbars=yes,status=yes');
                redirectWindow.location;
                          ...
                          this.modalService.open(contentperawat, {
                            ...
                            .subscribe(response => {
                              ...
                              if(response ){
                                ...
                                kdTindakanin = '';
                                this.toastr.error('BPJS : '+response.metaData.message+ '  ' +response.response[0].field+response.response[0].message, 'Sukses', {
                                  timeOut: 2000,
                                });
                              }
            ...
            .subscribe(
              data => {
                ...
                if(data.length){
                  ...
                  console.log(this.kddiagnosabpjs,this.kddiagnosabpjs2,this.kddiagnosabpjs3)
                }else{
           ...
           if(response ){
             ...
             this.toastr.error('Simpan  Gagal', 'Eror');
                 ...
                 pfkulitpalpasi:any='Normal: lembab, turgor baik/elastic, tidak ada edema';
                   ...
                   pfkukuinspeksi:any='Normal: bersih, bentuk normaltidak ada tanda-tanda jari tabuh (clubbing finger), tidak ikterik/sianosis';
                 ...
                 myvaluekepala= false;
                 pfkepalainspeksi:any='Normal: simetris, bersih, tidak ada lesi, tidak menunjukkan tanda-tanda kekurangan gizi(rambut jagung dan kering';
                 pfkepalapalpasi:any=' Normal: tidak ada penonjolan /pembengkakan, rambut lebat dan kuat/tidak rapuh';
                 kkepala(){
                  console.log('myValue:', this.myvaluekepala);
                 }

                  myvaluewajah= false;
                  pfwajahinspeksi:any='Normal: warna sama dengan bagian tubuh lain,  tidak pucat/ikterik, simetris.';
                  ...
                  myvaluemata=false;
                  pfmatainspeksi:any='Normal: simetris mata kika, simetris bola mata kika, warna konjungtiva pink, dan sclera berwarna putih.';
                  ...
                  pftelingainspeksi='Normal: bentuk dan posisi simetris kika, integritas kulit bagus, warna sama dengan kulit lain, tidak ada tanda-tanda infeksi, dan alat bantu dengar.';
                  ...
                  myvaluehidung=false;
                  pfhidunginspeksi='Normal: simetris kika, warna sama dengan warna kulit lain, tidak ada lesi, tidak ada sumbatan, perdarahan dan tanda-tanda infeksi.'
                  pfhidungapalpasi='Normal: tidak ada bengkak dan nyeri tekan.'
                  khidung(){
                     this.myvaluehidung ;
                  }
                  myvaluemulut=false;
                  pfmulutinspeksi='Normal: warna mukosa mulut dan bibir pink, lembab, tidak ada lesi dan stomatitis'
                  pfmulutapalpasi='Normal: gigi lengkap, tidak ada tanda-tanda gigi berlobang atau kerusakan gigi, tidak ada perdarahan atau radang gusi, lidah simetris, warna pink, langit2 utuh dan tidak ada tanda infeksi'
                  ...
                  pfleherinspeksi=' Normal: warna sama dengan kulit lain, integritas kulit baik, bentuk simetris, tidak ada pembesaran kelenjer gondok';
                  pfleheria='Normal: arteri karotis terdengar.';
                  pfleherial='Normal: tidak teraba pembesaran kel.gondok,tidak ada nyeri tidak ada pembesaran kel.limfe, tidak ada nyeri.'
...
tmpku(){
  this.authService.tampilku(this.notrans)
  .subscribe(
    data => {
      for (let x of data )
      {
  ...
  this.myvalueleher=x.leher
   ...
   this.myvalueperut=x.abdomen
    ...
    this.keterangangambar=x.keterangan
             ...
             this.authService.simpanku(body)
             .subscribe(response => {
                  ...
                  pilihtacc(a){
                   ...
                   if(a === '-1'){
                    ...
                    this.showempat=false;
                     ...
                     this.authService.cekdiag(this.notransaksi)
                     .subscribe(
                       data => {
                  ...
                  icare(){
                    ...
                    .subscribe(response => {
                      ...
                      if(response.metaData.code == 200){
                        ...
                        this.icareurl = this.domSanitizer.bypassSecurityTrustResourceUrl(response.response.url);
