...
URLINVOICE:string
  ...
  constructor(public hots:SampleService,public ObatconService:ObatconService,private modalService: NgbModal,public toastr: ToastrService, private authService:ApiserviceService , private fb: FormBuilder) {
      ...
      hapus(kdobat,
        ...
        swalWithBootstrapButtons.fire({
          ...
          if (result.value) {
            ...
            "standartd":'-',"sedang":'-',
            "sedangd":'-',"kemasan":'-',"kemasand":'-',"kdcabang":this.kdcabang,"kdklinik":this.kdklinik,
            "stssimpan":'3',"kdobat":kdobat,"kdobatbpjs":this.obatbpjs
            }
...
cariuserx(a){
  console.log(a.target.value)
   ...
   this.authService.obatmaster(this.kdcabang,'2',a.target.value,this.type)
  .subscribe(
    data => {
...
tmpobat(){
  this.authService.obat(this.kdcabang,'1','')
  .subscribe(
    data => {
  ...
  this.authService.carapemberian()
  .subscribe(
    data => {
  ...
  this.authService.bentuksediaan()
  .subscribe(
    data => {
...
cetakobat(){
  var redirectWindow = window.open(this.URLINVOICE+'clenic/report/listobat.php?kdcabang='+this.kdcabang, '_blank','location=no,toolbar=no,height=1000,width=1000,scrollbars=yes,status=yes');
...
cariobat(a){
  ...
  this.ObatconService.getobatbpjs(a.target.value)
  .subscribe(
    data => {
