...
@Component({
  selector: 'app-mutasifarmasiin',
  templateUrl: './mutasifarmasiin.component.html',
  styles: [
...
export class mutasifarmasiinComponent implements OnInit {
...
onqty(a){
  if(this.nomutasi === ''){
    ...
    this.authService.simpanmutasiin(body)
    .subscribe(response => {
...
.subscribe(response => {
  ...
  this.tbeli = data;
    ...
    caripas='1';
tmpbeli(){
  this.authService.listmutasiin(this.kdcabang,this.tglp,this.caripas,'')
  .subscribe(
    data => {
      this.totalpasenlist = data.length
this.tbeli = data;
