...
tmprek(){
  this.authService.rekening(this.kdcabang)
  .subscribe(
    data => {
    this.trek =data;
...
coadetail:any;
daftcoa(){
  this.authService.coaper('101.000',this.kdcabang)
   .subscribe(
     data => {
...
this.coadetail = data;
  ...
  simpan(){
    ...
    console.log(this.kdklinik,this.kdcabang,this.namarekening,this.norekening,this.norekeningl,this.kdcoarek,'1')
   
    this.authService.simpanrekening(this.kdklinik,this.kdcabang,this.namarekening,this.norekening,this.norekeningl,this.kdcoarek,'1').then(data =>{
      this.tmprek()
...
this.authService.carirekening(this.kdcabang,a.target.value)
.subscribe(data => {
  this.trek = data;
...
this.showedit = false;
 ...
 edituser(){
  ...
  this.authService.simpanrekening(this.kdklinik,this.kdcabang,this.namarekening,this.norekening,this.norekeningl,this.kdcoarek,'2').then(data =>{
    this.tmprek()
...
this.toastr.error('Simpan User Gagal', 'Eror');
 ...
 delet(norekening,namarekening,kdcoa,akun){
    ...
    swalWithBootstrapButtons.fire({
      ...
      if (result.value) {
        this.authService.simpanrekening(this.kdklinik,this.kdcabang,this.namarekening,norekening,norekening,this.kdcoarek,'3').then(data =>{
          this.tmprek()
