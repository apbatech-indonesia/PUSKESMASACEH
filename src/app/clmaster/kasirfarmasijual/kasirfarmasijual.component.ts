...
export class kasirfarmasijualComponent implements OnInit {
  ...
  nama_dokter: string = "";
  nomor_sip: string = "";
  alamat_dokter: string = "";
  paraf_dokter: string = "";
  tempat_tanggal_resep: string = "";
  nama_obat: string = "";
  ...
  ketidaktepatan_seleksi_obat: string = "";
  dosis_kurang: string = "";
  dosis_lebih: string = "";
  duplikasi: string = "";
  obat_tanpa_indikasi: string = "";
  indikasi_tidak_diobati: string = "";
  interaksi_obat: string = "";
  reaksi_obat_merugikan: string = "";
  gagal_menerima_obat: string = "";
  analisa: string = "";
  konseling: string = "";
  ...
  berat_badan_ket: string;
  jenis_kelamin_ket: string;
  nama_dokter_ket: string;
  alamat_dokter_ket: string;
  nomor_sip_ket: string;
  tempat_tanggal_resep_ket: string;
