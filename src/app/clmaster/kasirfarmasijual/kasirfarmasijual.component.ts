...
private baseUrl = GlobalComponent.urlsocketv;
  constructor(public hots:SampleService,
    public FarmasijualService :FarmasijualService,
    public router:Router,private datepipe: DatePipe,private modalService: NgbModal,public toastr: ToastrService, private authService:ApiserviceService , private fb: FormBuilder) {
...
showNotification(title: string, options?: NotificationOptions) {
  ...
  indexl++;
    ...
    this.authService.obated(this.kdcabang)
    .subscribe(
      data => {
...
this.showed = false;
    ...
    this.authService.verifshowdd(this.kdcabang)
    .subscribe(
      data => {
...
this.tsupshow = false;
    ...
    ubahqty(a,kdobat,notransaksi,nomor,qty,disc,discrp,harga){
      ...
      if(this.statuslunas === '2'){
        ...
        let body={
          "qtyedit":a.target.value,"kdobat":kdobat,"notransaksi":notransaksi,"nomor":nomor,
          "qty":qty,"disc":disc,"discrp":discrp,"harga":harga,"kdgudang":this.kdgudang,"stssimpan":'2',
  ...
  .subscribe(response => {
   ...
   console.log(response)
      ...
      if(response ){
          ...
          if(response === '1'){
            this.toastr.error('Hapus Gagal Karena Transaksi Belum di hapus atau trasaksi sudah di bayar', 'error');
    ...
    musnahkan(){
      ...
      swalWithBootstrapButtons.fire({
        ...
        if (result.value) {
          ...
          this.authService.musnahqty(body)
          .subscribe(response => {
...
this.showed = true;
  ...
  ktglrad(){
    ...
    if(this.statusku === '0'){
      ...
      // ri
      this.authService.t_listfarmasijual(this.kdcabang,'',this.tglp)
      .subscribe(
        data => {
          this.totalpasenlist = data.length
      this.tbeli = data;
...
if(this.stssimpan == '0'){
  this.authService.tescoba(this.kdcabang,this.notransaksi,this.nofaktur)
  .subscribe(
    data => {
...
this.toastr.error('Stok Di Gudang Utama Tidak Cukup Silahkan Cek Kembali atau Mutasi dari Stok Lain', 'error');
    

}else{

  let body={
    "nofaktur":this.nofaktur,"norm":this.norm,"pembulatan":this.pembulatan,"admresep":this.admresep,
    "tuslahresep":this.tuslahresep,"totaldisc":this.ttldisc,"totalbayar":this.netto,"sudahbayar":this.ttlterbayar,"statuslunas":
    '1',"kdgudang":this.kdgudang,"kdcabang":this.kdcabang,
    "keterangan":this.keterangan,"noresep":this.noresep,"tgl":this.tglpx,"kdklinik":this.kdklinik,"stssimpan":'1',"kdcus":this.kdkostumer,
    "kdpoli":this.kdpoli,"kddokter":this.kddokter
  }
...
let body={
  "kdklinik":this.kdklinik,"kdgudang":this.kdgudang,"keterangan":this.keterangan,"noresep":this.noresep,
  "nofaktur":this.nofaktur,"norm":this.norm,"stssimpan":'9',"kdcabang":this.kdcabang,
  "kdpoli":this.kdkamar,"kddokter":this.kddokter,"kdkostumer":this.kdkostumer
}
...
pilihpasien(nofaktur,tgl,pasien,kdpoli,nampoli,kdkostumerd,
  nama,kddokter,namdokter,notransaksi,sts,norm,statuslunas,bayar,ri)
  {
    ...
    console.log(nofaktur,tgl,pasien,kdpoli,nampoli,kdkostumerd,
      nama,kddokter,namdokter,notransaksi,sts,norm,statuslunas,bayar,ri)
...
this.total = 0;
    ...
    if(sts === '0'){
      ...
      this.authService.gudangdefault(this.kdcabang)
      .subscribe(
        data => {
...
"kdkus":this.kdkostumer,"kdgudang":this.kdgudang,"hargabeli":this.hargabeli,"stssimpan":'5'
    }
...
this.authService.simpanbeliverif(body)
  ...
  cetakfaktur(){
    var redirectWindow = window.open(this.URLINVOICE+'clenic/report/fakturpenjualan.php?notransaksi='+this.notransaksi+'&kdcabang='+this.kdcabang+'&username='+this.username, '_blank','location=no,toolbar=no,height=1000,width=1000,scrollbars=yes,status=yes');
    redirectWindow.location;
 }

 cetakfakturp(){
  var redirectWindow = window.open(this.URLINVOICE+'clenic/report/penjualanfarmasip.php?tgldari='+this.tgldari+'&tglsampai='+this.tglsampai+'&kdcabang='+this.kdcabang, '_blank','location=no,toolbar=no,height=1000,width=1000,scrollbars=yes,status=yes');
  redirectWindow.location;
}


cetakkridit(){
  var redirectWindow = window.open(this.URLINVOICE+'clenic/report/penjualanfarkasir.php?tgldari='+this.tgldari+'&tglsampai='+this.tglsampai+'&kdcabang='+this.kdcabang+'&user='+this.usercetak, '_blank','location=no,toolbar=no,height=1000,width=1000,scrollbars=yes,status=yes');
  redirectWindow.location;
}

cetakcash(){
  var redirectWindow = window.open(this.URLINVOICE+'clenic/report/penjualanfarkasir.php?tgldari='+this.tgldari+'&tglsampai='+this.tglsampai+'&kdcabang='+this.kdcabang+'&user='+this.usercetak+'&status=1', '_blank','location=no,toolbar=no,height=1000,width=1000,scrollbars=yes,status=yes');
  redirectWindow.location;
}

cetaklaped(){
  var redirectWindow = window.open(this.URLINVOICE+'clenic/report/expriedobatverif.php?kdcabang='+this.kdcabang+'&status=1', '_blank','location=no,toolbar=no,height=1000,width=1000,scrollbars=yes,status=yes');
  redirectWindow.location;
}
...
cetakfaktursp(){
  ...
  var redirectWindow = window.open(this.URLINVOICE+'clenic/report/belumbayarfarmasi.php?tgldari='+this.tgldari+'&tglsampai='+this.tglsampai+'&kdcabang='+this.kdcabang, '_blank','location=no,toolbar=no,height=1000,width=1000,scrollbars=yes,status=yes');
  redirectWindow.location;
}
num1:boolean;
num2:boolean;
...
lihated(content){
  this.authService.listobated(this.kdcabang)
  .subscribe(
    data => {
...
tpasien:any;
tmppasienri(){
  this.authService.pasienantrian(this.kdcabang,'11','','',this.tglp)
  .subscribe(
    data => {
...
pilihpasienx(norm,kddokter,kdkostumerd,notransaksi,
  pasien,nampoli,namdokter,nama,kdpoli,sts,kdkamar){
            ...
            .subscribe(
              data => {
                  ...
                  if(data.length){
                    ...
                    setTimeout(() => {
                      this.showloading = false
                      this.toastr.error('Simpan  Gagal Silahkan Ulangi Lagi', 'error');
                    }, 500);
                  }
...
this.kete = '';
      ...
      .subscribe(
        data => {
          ...
          if(data.length){
            ...
            this.modalService.open(contex).result.then((result) => {
    ...
    jbayar(a){
      ...
      bayartagihanakhir(){
        if(this.kembalian < 0){
          this.toastr.error('Tidak Bisa Simpan Karena Uang Dari Pasien Kurang', 'error');
        }else{
            if(this.ttlsisaterbayar <= 0){
                ...
                swalWithBootstrapButtons.fire({
                  ...
                  if (result.value) {
                    let body={
                      "kdbayar":'',"bayar":'',"jbayari":'',"sudahbayar":this.jumlahpasien,
                      "norm":this.norm,"bank":'',"kdklinik":this.kdklinik,"kdcabang":this.kdcabang,"notransaksi":this.notransaksi,
                    "kduser":this.username,"stssimpan":'3',"notransri":this.notransaksiri
                    }
        ...
        if(this.lunas === '1'){
          ...
          swalWithBootstrapButtons.fire({
            ...
            if (result.value) {
              ...
              let body={"kdcabang":this.kdcabang,"notransaksi":this.notransaksi,"notransri":this.notransaksiri,"kdbayar":'2',"bayar":'Kredit TF RI',
              "kduser":this.username,"stssimpan":'1',"norm":this.norm,"sudahbayar":this.ttlsisaterbayar,"kdkamar":this.kdkamar
              }
         
        
   
              this.authService.s_transferfarmasi(body)
              .subscribe(response => {
  ...
  this.authService.kajianrsesepa(body)
  .subscribe(response => {
  ...
  this.authService.kajianrsesepa(bodyx)
  .subscribe(response => {
  ...
  this.authService.kajianrsesepa(bodyxx)
  .subscribe(response => {
  ...
  tmpkajianresep(){
    this.authService.tampilkajianresep(this.noresep)
    .subscribe(
      data => {
