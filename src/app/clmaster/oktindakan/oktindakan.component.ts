...
@Component({
  selector: 'app-oktindakan',
  templateUrl: './oktindakan.component.html',
  styles: [
    `.example-container {
      display: flex;
...
export class oktindakanComponent implements OnInit {
...
dafatrdokter(){
  this.authService.t_oktindakan(this.kdcabang,'')
  .subscribe(
    data => {
  ...
  simpan(){
    ...
    this.authService.s_oktindakan(body)
    .subscribe(response => {
...
this.authService.t_oktindakan(this.kdcabang,a.target.value)
.subscribe(data => {
  this.tdokter = data;
...
this.showedit = false;
 ...
 edituser(){
  let body = {"nama":this.namadokter,"jenis":this.online,"kdtindakan":this.kdtindakan,
 ...
 delete(kdtindakan,nama,jenis){
    ...
    swalWithBootstrapButtons.fire({
      ...
      if (result.value) {
        ...
        let body = {"nama":nama,"jenis":jenis,"kdtindakan":kdtindakan,
