...
if(a === 'Kunjungan Rawat Jalan'){
 ...
 lihatbp(){
  var redirectWindow = window.open(this.URLINVOICE+'clenic/report/batalpriksa.php?tgldari='+this.tgldari+'&kdcabang='+this.kdcabang+'&tglsampai='+this.tglsampai+'&status='+this.kdklinik, '_blank','location=no,toolbar=no,height='+screen.height+',width='+screen.width+',scrollbars=yes,status=yes');
  redirectWindow.location;
 }
 lihatkunjunganexcel(){
