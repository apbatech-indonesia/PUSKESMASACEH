...
export class ermdokterComponent implements OnInit {
...
statuscari:any='';
  ...
  tmptotal(){
    this.authService.pasienperdokter(this.kdcabang,this.kduser,'BELUM','','2',this.statuscari)
    .subscribe(
      data => {
...
this.tampilpas = data;
    ...
    this.authService.pasienperdokter(this.kdcabang,this.kduser,'BELUM','','1',this.statuscari)
    .subscribe(
      data => {
this.totalpassbelum = data.length
    ...
    this.authService.pasienperdokter(this.kdcabang,this.kduser,'SUDAH','','1',this.statuscari)
    .subscribe(
      data => {
