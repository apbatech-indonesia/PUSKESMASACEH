...
@Component({
  selector: 'app-satusehat-mtbs',
  templateUrl: './satusehat-mtbs.component.html',
  providers: [
    DatePipe,
...
export class satusehatMtbsComponent implements OnInit {
...
kodeorg:any=''
tglss:any;
  constructor(public FarmasijualService:FarmasijualService, private router:Router,  private chatService: ChatService,private datepipe: DatePipe,private modalService: NgbModal,public toastr: ToastrService, private authService:ApiserviceService , private fb: FormBuilder) {
...
this.tglss = this.datepipe.transform(this.myDate,'yyyy-MM-ddTHH:mm:ss+07:00')
  ...
  tmptotal(){
    this.authService.pasienrm(this.kdcabang,'1','','2',this.tglpx,this.tglpxs)
    .subscribe(
      data => {
        this.tampilpas = data;
      },
