...
export class ManagementlabComponent implements OnInit {
  ...
  dash() {
    ...
    this.authService
      .jumlahpasiendashboard(this.kdcabang, "UMUM", this.tglpx)
      .subscribe(
        (data) => {
    ...
    this.authService
      .jumlahpasiendashboard(this.kdcabang, "ASURANSI", this.tglpx)
      .subscribe(
        (data) => {
    ...
    this.authService
      .jumlahpasiendashboard(this.kdcabang, "BPJS", this.tglpx)
      .subscribe(
        (data) => {
