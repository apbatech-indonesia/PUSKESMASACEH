...
export class ApiserviceService {
  ...
  setBaseUrlConfig(subDomain) {
    ...
    environment.baseUrl = environment.production ? "https://" + environment.subDomainName + ".clenicapp.com/clenic/" : environment.baseUrl;
    ...
    let rawatJalanUrl = environment.emrUrl + environment.apiPath + environment.subDomainName + environment.rawatJalanPath
    let socketUrl = "https://socket" + environment.subDomainName + ".clenicapp.com"
    let pcareUrl = environment.emrUrl + environment.apiPath + environment.subDomainName
...
// 
  ...
  getDetailDataKajianAwal(noRm, noTransaksi): Observable<Object> {
    return this.http.get(environment.rawatJalanUrl + "/" + noRm + "/" + noTransaksi)
  }
  ...
  getAllBpjsClub(clubCode: string) {
    return this.http.get(environment.pcareUrl + environment.pcareKelompokPath + "/get-club/" + clubCode)
  }

  getAllBpjsKegiatan(date: string) {
    return this.http.get(environment.pcareUrl + environment.pcareKelompokPath + "/get-kegiatan/" + date)
  }

  getAllBpjsPesertaKegiatan(eduID: string) {
    return this.http.get(environment.pcareUrl + environment.pcareKelompokPath + "/get-peserta/" + eduID)
  }

  getAllBpjsKegiatanDropdown() {
    return this.http.get(environment.pcareUrl + environment.pcareKelompokPath + "/get-drop-down")
  }

  deleteBpjsKegiatan(eduID: string) {
    return this.http.delete(environment.pcareUrl + environment.pcareKelompokPath + "/delete-kegiatan/" + eduID)
  }

  deleteBpjsPesertaKegiatan(eduID: string, noKartu: string) {
    return this.http.delete(environment.pcareUrl + environment.pcareKelompokPath + "/delete-peserta/" + eduID + "/" + noKartu)
  }

  addBpjsKegiatan(data: Object): Observable<Object> {
    return this.http.post(environment.pcareUrl + environment.pcareKelompokPath + "/add-kegiatan", data)
  }

  addBpjsPesertaKegiatan(data: Object): Observable<Object> {
    return this.http.post(environment.pcareUrl + environment.pcareKelompokPath + "/add-peserta", data)
  }

  getBpjsMCUAllPasien(nama: string = "", tglPeriksa: string = "") {
    if (nama !== "" || tglPeriksa !== "")
      return this.http.get(environment.pcareUrl + environment.pcareMcuPath + "/pasien?nama=" + nama + "&tglperiksa=" + tglPeriksa)
    else
      return this.http.get(environment.pcareUrl + environment.pcareMcuPath + "/pasien")
  }

  getBpjsMCUPasienDetail(noTransaksi: string = "") {
    return this.http.get(environment.pcareUrl + environment.pcareMcuPath + "/pasien/" +noTransaksi )
  }

  getBpjsMCU(noKunjungan: string = "") {
    return this.http.get(environment.pcareUrl + environment.pcareMcuPath + "/kunjungan/" + noKunjungan)
  }

  addBpjsMCU(data: Object): Observable<Object> {
    return this.http.post(environment.pcareUrl + environment.pcareMcuPath, data)
  }
  ...
  deleteBpjsMCU(kodeMCU, noKunjungan) {
    return this.http.delete(environment.pcareUrl + environment.pcareMcuPath + "/" + kodeMCU + "/kunjungan/" + noKunjungan)
  }

  getBpjsAllObat(noKunjungan: string = "") {
    return this.http.get(environment.pcareUrl + environment.pcareObatPath + "/kunjungan/" + noKunjungan)
  }

  addBpjsObat(data: Object): Observable<Object> {
    return this.http.post(environment.pcareUrl + environment.pcareObatPath + "/kunjungan", data)
  }
  ...
  listtariftree(a, b, c): Observable<any> {
    return this.http.get(apiurx + 'master/listtariftree.php?kdcabang=' + a + '&status=' + b + '&kdtarif=' + c)
  }
  ...
  listtariftreelabrad(a, b, c): Observable<any> {
    return this.http.get(apiurx + 'master/listtariftreelabrad.php?kdcabang=' + a + '&status=' + b + '&kdtarif=' + c)
  }
  ...
  coaper(a, b): Observable<any> {
    return this.http.get(apiurx + 'master/coaper.php?kdakun=' + a + '&kdcabang=' + b)
  }
  ...
  gudangcab(a, b): Observable<any> {
    return this.http.get(apiurx + 'master/gudangcab.php?kdklinik=' + a + '&kdcabang=' + b)
  }
  carigudang(a, b): Observable<any> {
    return this.http.get(apiurx + 'master/carigudang.php?kdklinik=' + a + '&nama=' + b)
  }
  ...
  cabangbyid(a, b): Observable<any> {
    return this.http.get(apiurx + 'master/cabangbyid.php?kdklinik=' + a + '&kdcabang=' + b)
  }

  caricabang(a, b): Observable<any> {
    return this.http.get(apiurx + 'master/caricabang.php?kdklinik=' + a + '&nama=' + b)
  }
  ...
  cariuser(a, b): Observable<any> {
    return this.http.get(apiurx + 'master/cariuser.php?kdklinik=' + a + '&nama=' + b)
  }
  caricoa(a, b, c, d): Observable<any> {
    return this.http.get(apiurx + 'master/caricoa.php?kdcabang=' + a + '&coa=' + b + '&sts=' + c + '&parent=' + d)
  }
  caridiagnosa(a, b): Observable<any> {
    return this.http.get(apiurx + 'master/caridiagnosa.php?diagnosa=' + a + '&sts=' + b)
  }

  caritindakan(a, b): Observable<any> {
    return this.http.get(apiurx + 'master/caritindakan.php?tindakan=' + a + '&sts=' + b)
  }
  ...
  caripoli(a, b): Observable<any> {
    return this.http.get(apiurx + 'master/caripoli.php?kdcabang=' + a + '&nampoli=' + b)
  }

  rakobat(a, b): Observable<any> {
    return this.http.get(apiurx + 'master/rakobat.php?kdcabang=' + a + '&namarak=' + b)
  }

  carigolobat(a, b): Observable<any> {
    return this.http.get(apiurx + 'master/carigolobat.php?dari=' + a + '&nama=' + b)
  }

  carisuplier(a, b, c): Observable<any> {
    return this.http.get(apiurx + 'master/carisuplier.php?dari=' + a + '&nama=' + b + '&kdcabang=' + c)
  }
  ...
  promo(a, b): Observable<any> {
    return this.http.get(apiurx + 'transaksi/tampilpromo.php?kdcabang=' + a + '&judulpromo=' + b)
  }
  ...
  doktertunjang(a, b): Observable<any> {
    return this.http.get(apiurx + 'master/doktertunjang.php?kdcabang=' + a + '&sts=' + b)
  }

  dokterperpoli(a, b): Observable<any> {
    return this.http.get(apiurx + 'master/dokterperpoli.php?kdcabang=' + a + '&kddokter=' + b)
  }
  profil(a, b): Observable<any> {
    return this.http.get(apiurx + 'transaksi/profil.php?kdcabang=' + a + '&kddokter=' + b)
  }
  ulasan(a, b): Observable<any> {
    return this.http.get(apiurx + 'transaksi/ulasan.php?kdcabang=' + a + '&kddokter=' + b)
  }
  dokterperpolix(a, kdpoli): Observable<any> {
    return this.http.get(apiurx + 'master/dokterperpolix.php?kdcabang=' + a + '&kdpoli=' + kdpoli)
  }

  caridokter(a, b): Observable<any> {
    return this.http.get(apiurx + 'master/caridokter.php?kdcabang=' + a + '&dokter=' + b)
  }
  carirekening(a, b): Observable<any> {
    return this.http.get(apiurx + 'master/carirekening.php?kdcabang=' + a + '&akun=' + b)
  }


  simpanuser(Username, password, namal, hakakses, kdcb, kdklinik, stssimpan, kduser) {
    let url = apiurx + 'master/simpanuser.php';
    let param = { username: Username, password: password, nama: namal, hakakses: hakakses, kdcabang: kdcb, kdklinik: kdklinik, stssimpan: stssimpan, kduserlogin: kduser };
  ...
  simpanuserx(username, kddokter, kdcabang, kdklinik, stssimpan) {
    let url = apiurx + 'master/simpanuser.php';
    let param = { username: username, kddokter: kddokter, kdcabang: kdcabang, kdklinik: kdklinik, stssimpan: stssimpan };
    let request = this.http.post(url, param);
    return request.toPromise();
  }
  ...
  simpancabang(cabang, alamat, hp, kdcabang, sts, kdklinik) {
    ...
    let param = { kdklinik: kdklinik, nama: cabang, alamat: alamat, hp: hp, kdcabang: kdcabang, stssimpan: sts };
    let request = this.http.post(url, param);
    return request.toPromise();
  ...
  simpangudang(kdgudang, gudang, kdklinik, kdcabang, sts, hakakses) {
    ...
    let param = { kdgudang: kdgudang, gudang: gudang, kdklinik: kdklinik, kdcabang: kdcabang, stssimpan: sts, hakakses: hakakses };
    let request = this.http.post(url, param);
    return request.toPromise();
  ...
  simpanpoli(kdklinik, kdcabang, kdpoli, nampoli, sts, hakakses,polibpjs) {
    ...
    let param = { kdklinik: kdklinik, kdcabang: kdcabang, stssimpan: sts, kdpoli: kdpoli, poli: nampoli, hakakses: hakakses,polibpjs:polibpjs };
    let request = this.http.post(url, param);
    return request.toPromise();
  ...
  nocoa(kdklinik, kdcabang, kdcoa, namacoa) {
    ...
    let param = { kdklinik: kdklinik, kdcabang: kdcabang, kdcoa: kdcoa, namacoa: namacoa };
    let request = this.http.post(url, param);
    return request.toPromise();
  ...
  editcoa(kdklinik, kdcabang, kdcoa, namacoa, stssimpan) {
    ...
    let param = { kdklinik: kdklinik, kdcabang: kdcabang, kdcoa: kdcoa, namacoa: namacoa, stssimpan: stssimpan };
    let request = this.http.post(url, param);
    return request.toPromise();
  ...
  simpanrekening(kdklinik, kdcabang, namarekening, norekening, norekeningl, kdcoarek, sts) {
    let url = apiurx + 'master/simpanrekening.php';
    let param = { kdklinik: kdklinik, kdcabang: kdcabang, kdcoa: kdcoarek, namarekening: namarekening, norekening: norekening, norekeningl: norekeningl, stssimpan: sts };
    let request = this.http.post(url, param);
    return request.toPromise();
  }
  ...
  simpandokterpoli(kdklinik, kdcabang, kddokter, kdpoli, sts) {
    ...
    let param = { kdklinik: kdklinik, kdcabang: kdcabang, stssimpan: sts, kdpoli: kdpoli, kddokter: kddokter };
    let request = this.http.post(url, param);
    return request.toPromise();
  }
  ...
  simpranrak(kdcabang, kdklinik, inrak, kdrak, sts) {
    ...
    let param = { kdklinik: kdklinik, kdcabang: kdcabang, stssimpan: sts, namarak: inrak, kdrak: kdrak };
    let request = this.http.post(url, param);
    return request.toPromise();
  ...
  simpansuplier(kdcabang, kdklinik, insup, inalamat, inhp, kdsup, sts) {
    ...
    let param = { kdklinik: kdklinik, kdcabang: kdcabang, stssimpan: sts, nama: insup, alamat: inalamat, hp: inhp, kdsup: kdsup };
    let request = this.http.post(url, param);
    return request.toPromise();
  }
  ...
  simpanpabrikan(kdcabang, kdklinik, insup, inalamat, inhp, kdpabrikan, sts) {
    ...
    let param = { kdklinik: kdklinik, kdcabang: kdcabang, stssimpan: sts, nama: insup, alamat: inalamat, hp: inhp, kdpabrikan: kdpabrikan };
    let request = this.http.post(url, param);
    return request.toPromise();
  }
  ...
  simpanuploadlab(kdcabang, notrans, file, norm, keterangan) {
    ...
    let param = { kdcabang: kdcabang, notrans: notrans, file: file, norm: norm, keterangan: keterangan };
    let request = this.http.post(url, param);
    return request.toPromise();
  }
  ...
  simpanprofildokter(kdcabang, kddokter, sp, lulusan, diskripsi, pengalaman, file) {
    let url = apiurx + 'transaksi/simpanprofildokter.php';
    let param = { kdcabang: kdcabang, kddokter: kddokter, sp: sp, lulusan: lulusan, diskripsi: diskripsi, pengalaman: pengalaman, file: file };
    let request = this.http.post(url, param);
    return request.toPromise();
  }
  ...
  simpanpromo(kdcabang, sp, diskripsi, statusaktif, stssimpan, file, kdklinik, kdpromo, showkkk) {
    let url = apiurx + 'transaksi/simpanpromo.php';
    let param = {
      kdcabang: kdcabang, sp: sp, diskripsi: diskripsi, kdklinik: kdklinik, file: file, statusaktif: statusaktif
      , stssimpan: stssimpan, kdpromo: kdpromo, showkkk: showkkk
    };
    let request = this.http.post(url, param);
    return request.toPromise();
  }
  ...
  simpanberita(sp, htmlContent, statusaktif, stssimpan, imageSrc, kdberita) {
    ...
    let param = {
      sp: sp, isi: htmlContent, katagori: statusaktif, file: imageSrc, stssimpan: stssimpan, kdberita: kdberita
    };
    let request = this.http.post(url, param);
    return request.toPromise();
  }
  ...
  kabupaten(a, nama): Observable<any> {
    return this.http.get(apidaftar + 'kabupaten.php?kdprop=' + a + '&nama=' + nama)
  }

  kecamatan(a, nama): Observable<any> {
    return this.http.get(apidaftar + 'kecamatan.php?kdkab=' + a + '&nama=' + nama)
  }

  keluarahan(a, nama): Observable<any> {
    return this.http.get(apidaftar + 'keluarahan.php?kdkec=' + a + '&nama=' + nama)
  }
  ...
  kloter(a, b): Observable<any> {
    return this.http.get(apidaftar + 'kloter.php?kdklinik=' + a + '&kddokter=' + b)
  }
  ...
  waktuTunggucb2(notrans, no, norm) {
    return this.http.get('https://clenicapp.com/rjx/ws_antrianbpjs/waktuTunggucb2.php?notrans=' + notrans + '&no=' + no + '&norm=' + norm)
  }

  waktuTunggucb3(notrans, no) {
    return this.http.get('https://clenicapp.com/rjx/ws_antrianbpjs/waktuTunggucb.php?notrans=' + notrans + '&no=' + no)
  }
  ...
  obat(a, b, c): Observable<any> {
    return this.http.get(apiurx + 'master/obat.php?kdcabang=' + a + '&sts=' + b + '&nama=' + c)
  }
  obatmaster(a, b, c, d): Observable<any> {
    return this.http.get(apiurx + 'master/obatmaster.php?kdcabang=' + a + '&sts=' + b + '&nama=' + c + '&type=' + d)
  }

  obaterm(a, b, c): Observable<any> {
    return this.http.get(apiurx + 'master/obaterm.php?kdcabang=' + a + '&sts=' + b + '&nama=' + c)
  }

  cobatbeli(a, b, c): Observable<any> {
    return this.http.get(apiurx + 'master/cobatbeli.php?kdcabang=' + a + '&sts=' + b + '&nama=' + c)
  }


  obatbykode(a, b): Observable<any> {
    return this.http.get(apiurx + 'master/obatbykode.php?kdcabang=' + a + '&kdobat=' + b)
  }

  obatbysatuan(a, b, c): Observable<any> {
    return this.http.get(apiurx + 'master/satuancari.php?kdcabang=' + a + '&kdobat=' + b + '&satuan=' + c)
  }


  obatbykodestok(a, b, c): Observable<any> {
    return this.http.get(apiurx + 'master/obatbykodestok.php?kdcabang=' + a + '&kdobat=' + b + '&kdgudang=' + c)
  }


  obatr(a, b, c): Observable<any> {
    return this.http.get(apiurx + 'master/obatr.php?kdcabang=' + a + '&kddokter=' + b + '&kdtamplate=' + c)
  }


  obatbyid(a, b): Observable<any> {
    return this.http.get(apiurx + 'master/obatbyid.php?kdcabang=' + a + '&kdobat=' + b)
  }

  riwayatobat(a, b): Observable<any> {
    return this.http.get(apiurx + 'transaksi/riwayatobat.php?kdcabang=' + a + '&norm=' + b)
  }
  ...
  kostumer(a, b, c): Observable<any> {
    return this.http.get(apiurx + 'master/kostumer.php?kdcabang=' + a + '&sts=' + b + '&nama=' + c)
  }


  tarifm(a, b, c): Observable<any> {
    return this.http.get(apiurx + 'master/tarifm.php?kdcabang=' + a + '&sts=' + b + '&nama=' + c)
  }
  teslab(a, b, c, d): Observable<any> {
    // kdcabang=002&kdgolongan=ML12&dari=1&nama=
    return this.http.get(apiurx + 'master/teslab.php?kdcabang=' + a + '&kdgolongan=' + b + '&nama=' + c + '&dari=' + d)
  }

  tarifkomponen(a, c): Observable<any> {
    return this.http.get(apiurx + 'master/tarifkomponen.php?kdcabang=' + a + '&kdtarif=' + c)
  }

  tarifdetail(a, b, c, kdtarifm, statust): Observable<any> {
    return this.http.get(apiurx + 'master/tarifdetail.php?kdcabang=' + a + '&sts=' + b + '&nama=' + c + '&kdtarifm=' + kdtarifm + '&statust=' + statust)
  }


  kostumerd(a, b, c, kdkelompok): Observable<any> {
    return this.http.get(apiurx + 'master/kostumerd.php?kdcabang=' + a + '&sts=' + b + '&nama=' + c + '&kdkelompok=' + kdkelompok)
  }

  tamplateos(a, b, c, nama): Observable<any> {
    return this.http.get(apiurx + 'master/tamplateos.php?kdcabang=' + a + '&kduser=' + b + '&status=' + c + '&nama=' + nama)
  }
  tamplateobat(a, b, c, nama, kdtamplate): Observable<any> {
    return this.http.get(apiurx + 'master/tamplateobat.php?kdcabang=' + a + '&kduser=' + b + '&status=' + c + '&nama=' + nama + '&kdtamplate=' + kdtamplate)
  }


  pasien(a, b, nama): Observable<any> {
    return this.http.get(apiurx + 'master/pasien.php?kdcabang=' + a + '&sts=' + b + '&nama=' + nama)
  }

  hasiltamplateobat(a, b, nama): Observable<any> {
    return this.http.get(apiurx + 'master/hasiltamplateobat.php?kdcabang=' + a + '&kduser=' + b + '&nama=' + nama)
  }

  hasiltamplatebhp(a, nama): Observable<any> {
    return this.http.get(apiurx + 'master/hasiltamplatebhp.php?kdcabang=' + a + '&nama=' + nama)
  }
  ...
  nomorobat(a, b): Observable<any> {
    return this.http.get(apiurx + 'master/nomorobat.php?kdcabang=' + a + '&kduser=' + b)
  }

  t_masterkelaskamar(a, b): Observable<any> {
    return this.http.get(apiurx + 'ri/t_masterkelaskamar.php?kdcabang=' + a + '&nama=' + b)
  }

  datapasienri(a, b): Observable<any> {
    return this.http.get(apiurx + 'ri/datapasienri.php?kdcabang=' + a + '&notrans=' + b)
  }



  t_outstandingrj(a, b): Observable<any> {
    return this.http.get(apiurx + 'ri/t_outstandingrj.php?kdcabang=' + a + '&norm=' + b)
  }

  t_outstandingfar(a, b): Observable<any> {
    return this.http.get(apiurx + 'ri/t_outstandingfar.php?kdcabang=' + a + '&norm=' + b)
  }



  t_spesialisasimaping(a, b): Observable<any> {
    return this.http.get(apiurx + 'ri/t_spesialisasimaping.php?kdcabang=' + a + '&kdspesial=' + b)
  }

  t_listfarmasijual(a, b, c): Observable<any> {
    return this.http.get(apiurx + 'ri/t_listfarmasijual.php?kdcabang=' + a + '&nama=' + b + '&tgl=' + c)
  }
  ...
  t_listpasienri(a, b): Observable<any> {
    return this.http.get(apiurx + 'ri/t_listpasienri.php?kdcabang=' + a + '&nama=' + b)
  }
  t_rwtlistpasienri(a, b, c): Observable<any> {
    return this.http.get(apiurx + 'ri/t_rwtlistpasienri.php?kdcabang=' + a + '&nama=' + b + '&tgl=' + c)
  }
  t_listtrxrekap(a, b): Observable<any> {
    return this.http.get(apiurx + 'ri/t_listtrxrekap.php?kdcabang=' + a + '&notransaksi=' + b)
  }
  t_kostumerd(a, b): Observable<any> {
    return this.http.get(apiurx + 'ri/t_kostumerd.php?kdcabang=' + a + '&nama=' + b)
  }
  ...
  t_listpasienridokter(a, b, c): Observable<any> {
    return this.http.get(apiurx + 'ri/t_listpasienridokter.php?kdcabang=' + a + '&nama=' + b + '&kddokter=' + c)
  }


  listtarif(a, b, c, kdtarif): Observable<any> {
    return this.http.get(apiurx + 'master/listtarif.php?kdcabang=' + a + '&sts=' + b + '&nama=' + c + '&kdtarif=' + kdtarif)
  }
  ...
  pasienantrian(kdcabang, sts, notransaksi, nama, tgl): Observable<any> {
    return this.http.get(apiurx + 'master/pasienantrian.php?kdcabang=' + kdcabang + '&sts=' + sts + '&notransaksi=' + notransaksi + '&nama=' + nama + '&tgl=' + tgl)
  }
  pasienantrianppoli(kdcabang, sts, nama, tgl, statuscari): Observable<any> {
    return this.http.get(apiurx + 'master/pasienantrianppoli.php?kdcabang=' + kdcabang + '&sts=' + sts + '&nama=' + nama + '&tgl=' + tgl + '&statuscari=' + statuscari)
  }

  pasienantrianlab(kdcabang, sts, nama, tgl, statuscari): Observable<any> {
    return this.http.get(apiurx + 'master/pasienantrianlab.php?kdcabang=' + kdcabang + '&sts=' + sts + '&nama=' + nama + '&tgl=' + tgl + '&statuscari=' + statuscari)
  }
  ...
  listtrxrj(a, b, c, sts): Observable<any> {
    return this.http.get(apiurx + 'transaksi/listtrxrj.php?kdcabang=' + a + '&nofaktur=' + b + '&nama=' + c + '&sts=' + sts)
  }
  listtrxri(a, b, c): Observable<any> {
    return this.http.get(apiurx + 'transaksi/listtrxri.php?kdcabang=' + a + '&nofaktur=' + b + '&nama=' + c)
  }


  listtrxrjpenunjang(a, b, c, sts): Observable<any> {
    return this.http.get(apiurx + 'transaksi/listtrxrjpenunjang.php?kdcabang=' + a + '&nofaktur=' + b + '&nama=' + c + '&sts=' + sts)
  }
  t_listtrxpen(a, b, c, sts): Observable<any> {
    return this.http.get(apiurx + 'ri/t_listtrxpen.php?kdcabang=' + a + '&nofaktur=' + b + '&nama=' + c + '&sts=' + sts)
  }
  ...
  totalfarmasi(a, b): Observable<any> {
    return this.http.get(apiurx + 'transaksi/totalfarmasi.php?kdcabang=' + a + '&nofaktur=' + b)
  }
  trigerbayar(a, b): Observable<any> {
    return this.http.get(apiurx + 'transaksi/trigerbayar.php?kdcabang=' + a + '&notrans=' + b)
  }
  listdaftartunjang(a, b): Observable<any> {
    return this.http.get(apiurx + 'transaksi/listdaftartunjang.php?kdcabang=' + a + '&nofaktur=' + b)
  }


  jenisbayar(a, b): Observable<any> {
    return this.http.get(apiurx + 'transaksi/jenisbayar.php?sts=' + a + '&kd=' + b)
  }
  listbank(a): Observable<any> {
    return this.http.get(apiurx + 'transaksi/listbank.php?kdcabang=' + a)
  }
  plafonbpjs(a, b): Observable<any> {
    return this.http.get(apiurx + 'transaksi/plafonbpjs.php?kdcabang=' + a + '&kelas=' + b)
  }

  listtrxfarrj(a, b, c, d): Observable<any> {
    return this.http.get(apiurx + 'transaksi/listtrxfarrj.php?kdcabang=' + a + '&notransaksi=' + b + '&sts=' + c + '&obat=' + d)
  }

  listtrxfarrja(a, b): Observable<any> {
    return this.http.get(apiurx + 'transaksi/listtrxfarrja.php?kdcabang=' + a + '&notransaksi=' + b)
  }
  metode(a, b, c): Observable<any> {
    return this.http.get(apiurx + 'master/metode.php?kdcabang=' + a + '&nama=' + b + '&dari=' + c)
  }
  golongan(a, b, c): Observable<any> {
    return this.http.get(apiurx + 'master/golongan.php?kdcabang=' + a + '&nama=' + b + '&dari=' + c)
  }

  t_masterkamarinduk(a, b): Observable<any> {
    return this.http.get(apiurx + 'ri/t_masterkamarinduk.php?kdcabang=' + a + '&nama=' + b)
  }
  t_ceknorm(a, b): Observable<any> {
    return this.http.get(apiurx + 'ri/t_ceknorm.php?kdcabang=' + a + '&norm=' + b)
  }
  t_kamar(a, b): Observable<any> {
    return this.http.get(apiurx + 'ri/t_kamar.php?kdcabang=' + a + '&nama=' + b)
  }
  t_kamarkelas(a, b, c): Observable<any> {
    return this.http.get(apiurx + 'ri/t_kamarkelas.php?kdcabang=' + a + '&nama=' + b + '&kdkelas=' + c)
  }

  t_oktindakan(a, b): Observable<any> {
    return this.http.get(apiurx + 'ri/t_oktindakan.php?kdcabang=' + a + '&nama=' + b)
  }
  t_spesialisasi(a, b): Observable<any> {
    return this.http.get(apiurx + 'ri/t_spesialisasi.php?kdcabang=' + a + '&nama=' + b)
  }
  t_mperawat(a, b): Observable<any> {
    return this.http.get(apiurx + 'ri/t_mperawat.php?kdcabang=' + a + '&nama=' + b)
  }
  tamplatelab(a, b, c): Observable<any> {
    return this.http.get(apiurx + 'master/tamplatelab.php?kdcabang=' + a + '&notransaksi=' + b + '&jk=' + c)
  }
  tamplatelabb(a, b, c): Observable<any> {
    return this.http.get(apiurx + 'master/tamplatelabb.php?kdcabang=' + a + '&notransaksi=' + b + '&jk=' + c)
  }
  mapinglab(a, b): Observable<any> {
    return this.http.get(apiurx + 'master/mapinglab.php?kdcabang=' + a + '&kdproduk=' + b)
  }

  listkomponentrx(a, b, c, nomor): Observable<any> {
    return this.http.get(apiurx + 'transaksi/listkomponentrx.php?kdcabang=' + a + '&notrans=' + b + '&kdproduk=' + c + '&nomor=' + nomor)
  }
  jumlahpasiendashboard(a, b, c): Observable<any> {
    return this.http.get(apiurx + 'transaksi/jumlahpasiendashboard.php?kdcabang=' + a + '&sts=' + b + '&tgl=' + c)
  }
  polipie(a, b): Observable<any> {
    return this.http.get(apiurx + 'master/polipie.php?kdcabang=' + a + '&tgl=' + b)
  }
  grafik(a): Observable<any> {
    return this.http.get(apiurx + 'master/grafik.php?kdcabang=' + a)
  }
  grafikbpjs(a, b): Observable<any> {
    return this.http.get(apiurx + 'master/grafikbpjs.php?kdcabang=' + a + '&sts=' + b)
  }
  hasilradiologi(a, b, c): Observable<any> {
    return this.http.get(apiurx + 'transaksi/hasilradiologi.php?kdcabang=' + a + '&notransaksi=' + b + '&kdproduk=' + c)
  }

  pasienperdokter(a, b, c, d, e, f): Observable<any> {
    return this.http.get(apiurx + 'transaksi/pasienperdokter.php?kdcabang=' + a + '&kddokter=' + b + '&sts=' + c + '&nama=' + d + '&stss=' + e + '&status=' + f)
  }
  pasienperdokterri(a, b, c, d, e, f): Observable<any> {
    return this.http.get(apiurx + 'transaksi/pasienperdokterri.php?kdcabang=' + a + '&kddokter=' + b + '&sts=' + c + '&nama=' + d + '&stss=' + e + '&status=' + f)
  }

  datapasien(a, b): Observable<any> {
    return this.http.get(apiurx + 'transaksi/datapasien.php?kdcabang=' + a + '&notrans=' + b)
  }
  ...
  riwayatlaborat(a, b): Observable<any> {
    return this.http.get(apiurx + 'transaksi/riwayatlaborat.php?kdcabang=' + a + '&norm=' + b)
  }


  trackhasillab(a, b, c): Observable<any> {
    return this.http.get(apiurx + 'master/trackhasillab.php?kdcabang=' + a + '&norm=' + b + '&kdlab=' + c)
  }
  ...
  riwayatradiologi(a, b): Observable<any> {
    return this.http.get(apiurx + 'transaksi/riwayatradiologi.php?kdcabang=' + a + '&norm=' + b)
  }
  diagnosatmp(a, b, c): Observable<any> {
    return this.http.get(apiurx + 'transaksi/diagnosa.php?kdcabang=' + a + '&notrans=' + b + '&sts=' + c)
  }
  diagnosacopy(a, b, c, d): Observable<any> {
    return this.http.get(apiurx + 'transaksi/diagnosacopy.php?kdcabang=' + a + '&norm=' + b + '&sts=' + c + '&kdpoli=' + d)
  }


  tampilcppt(a, b): Observable<any> {
    return this.http.get(apiurx + 'transaksi/tampilcppt.php?kdcabang=' + a + '&notrans=' + b)
  }


  selesaiverif(a, b, c): Observable<any> {
    return this.http.get(apiurx + 'transaksi/selesaiverif.php?kdcabang=' + a + '&notrans=' + b + '&sts=' + c)
  }
  tampilcpptlist(a, b, c, d): Observable<any> {
    return this.http.get(apiurx + 'transaksi/tampilcpptlist.php?kdcabang=' + a + '&norm=' + b + '&kddokter=' + c + '&kdpoli=' + d)
  }

  listintruksilab(a, b, c, d): Observable<any> {
    return this.http.get(apiurx + 'transaksi/listintruksilab.php?kdcabang=' + a + '&notrans=' + b + '&sts=' + c + '&kdcppt=' + d)
  }

  verifhapus(a, b, c, d, e, f, g): Observable<any> {

    return this.http.get(apiurx + 'transaksi/verifhapus.php?kdcabang=' + a +
      '&notrans=' + b + '&sts=' + c + '&kdcppt=' + d + '&kddokter=' + e + '&kdpoli=' + f + '&kdpruduk=' + g)
  }

  keteranganklinis(a, b, c, d): Observable<any> {
    return this.http.get(apiurx + 'transaksi/keteranganklinis.php?kdcabang=' + a + '&notrans=' + b + '&sts=' + c + '&kdcppt=' + d)
  }

  nomorracik(a, b, c): Observable<any> {
    return this.http.get(apiurx + 'transaksi/nomorracik.php?kdcabang=' + a + '&notrans=' + b + '&norm=' + c)
  }

  obatnonracik(a, b, c): Observable<any> {
    return this.http.get(apiurx + 'transaksi/obatnonracik.php?kdcabang=' + a + '&notrans=' + b + '&kdcppt=' + c)
  }

  tmpbhp(a, b, c): Observable<any> {
    return this.http.get(apiurx + 'transaksi/tmpbhp.php?kdcabang=' + a + '&notrans=' + b + '&kdcppt=' + c)
  }

  listpobaterm(a, b): Observable<any> {
    return this.http.get(apiurx + 'transaksi/listpobaterm.php?kdcabang=' + a + '&notrans=' + b)
  }

  listobatermracik(a, b): Observable<any> {
    return this.http.get(apiurx + 'transaksi/listobatermracik.php?kdcabang=' + a + '&notrans=' + b)
  }
  obatracik(a, b, c, d): Observable<any> {
    return this.http.get(apiurx + 'transaksi/obatracik.php?kdcabang=' + a + '&notrans=' + b + '&kdcppt=' + c + '&kode=' + d)
  }


  estimasibiaya(a, b): Observable<any> {
    return this.http.get(apiurx + 'transaksi/estimasibiaya.php?kdcabang=' + a + '&notrans=' + b)
  }
  ...
  caripembelian(a, b, c, d, tgls): Observable<any> {
    return this.http.get(apiurx + 'master/caripembelian.php?kdcabang=' + a + '&tgl=' + b + '&sts=' + c + '&nama=' + d + '&tgls=' + tgls)
  }

  listmutasi(a, b, c, d): Observable<any> {
    return this.http.get(apiurx + 'master/listmutasi.php?kdcabang=' + a + '&tgl=' + b + '&sts=' + c + '&nama=' + d)
  }
  listmutasiin(a, b, c, d): Observable<any> {
    return this.http.get(apiurx + 'master/listmutasiin.php?kdcabang=' + a + '&tgl=' + b + '&sts=' + c + '&nama=' + d)
  }
  listmutasiout(a, b, c, d): Observable<any> {
    return this.http.get(apiurx + 'master/listmutasiout.php?kdcabang=' + a + '&tgl=' + b + '&sts=' + c + '&nama=' + d)
  }
  caripembelianr(a, b, c, d): Observable<any> {
    return this.http.get(apiurx + 'master/caripembelianr.php?kdcabang=' + a + '&tgl=' + b + '&sts=' + c + '&nama=' + d)
  }


  listfarmasijual(a, c, d, e): Observable<any> {
    return this.http.get(apiurx + 'master/listfarmasijual.php?kdcabang=' + a + '&sts=' + c + '&nama=' + d + '&tgl=' + e)
  }

  listpiutang(a, c, d, e): Observable<any> {
    return this.http.get(apiurx + 'master/listpiutang.php?kdcabang=' + a + '&sts=' + c + '&nama=' + d + '&tgl=' + e)
  }



  listfarmasijualretur(a, c, d, e): Observable<any> {
    return this.http.get(apiurx + 'master/listfarmasijualretur.php?kdcabang=' + a + '&sts=' + c + '&nama=' + d + '&tgl=' + e)
  }


  cariretur(a, b, c, d): Observable<any> {
    return this.http.get(apiurx + 'master/cariretur.php?kdcabang=' + a + '&tgl=' + b + '&sts=' + c + '&nama=' + d)
  }
  ...
  trxjual(a, b, c): Observable<any> {
    return this.http.get(apiurx + 'transaksi/trxjual.php?kdcabang=' + a + '&nofaktur=' + b + '&notrans=' + c)
  }
  trxjualx(a, b, c): Observable<any> {
    return this.http.get(apiurx + 'transaksi/trxjualx.php?kdcabang=' + a + '&nofaktur=' + b + '&notrans=' + c)
  }
  ...
  panggiladmisi(a): Observable<any> {
    return this.http.get('http://localhost:8011/clenic/transaksi/panggiladmisi.php?no=' + a)
  }
  panggilantrian(a, b): Observable<any> {
    return this.http.get('http://localhost:8011/clenic/transaksi/panggilantrian.php?no=' + a + '&dokter=' + b)
  }



  listtrxcppt(a, c): Observable<any> {
    return this.http.get(apiurx + 'transaksi/listtrxcppt.php?kdcabang=' + a + '&notrans=' + c)
  }
  ...
  totalpenjualan(a, b): Observable<any> {
    return this.http.get(apiurx + 'master/totalpenjualan.php?kdcabang=' + a + '&tgl=' + b)
  }
  ...
  cobatjual(a, b, c): Observable<any> {
    return this.http.get(apiurx + 'master/cobatjual.php?kdcabang=' + a + '&kdgudang=' + b + '&nama=' + c)
  }
  pasiensemua(a, b, c): Observable<any> {
    return this.http.get(apiurx + 'master/pasiensemua.php?kdcabang=' + a + '&sts=' + b + '&nama=' + c)
  }
  tescoba(a, b, c): Observable<any> {
    return this.http.get(apiurx + 'transaksi/tes.php?kdcabang=' + a + '&notransaksi=' + b + '&nofaktur=' + c)
  }

  etiket(a, b): Observable<any> {
    return this.http.get(apiurx + 'transaksi/etiket.php?kdcabang=' + a + '&notransaksi=' + b)
  }
  kostumerlist(a, b): Observable<any> {
    return this.http.get(apiurx + 'master/kostumerlist.php?kdcabang=' + a + '&nama=' + b)
  }
  trxmutasi(a, b): Observable<any> {
    return this.http.get(apiurx + 'transaksi/trxmutasi.php?kdcabang=' + a + '&nomutasi=' + b)
  }
  trxmutasiin(a, b): Observable<any> {
    return this.http.get(apiurx + 'transaksi/trxmutasiin.php?kdcabang=' + a + '&nomutasi=' + b)
  }

  trxmutasiout(a, b): Observable<any> {
    return this.http.get(apiurx + 'transaksi/trxmutasiout.php?kdcabang=' + a + '&nomutasi=' + b)
  }
  pendapatanrjdepan(a, b): Observable<any> {
    return this.http.get(apiurx + 'transaksi/pendapatanrjdepan.php?kdcabang=' + a + '&tgl=' + b)
  }
  ...
  listbayarpiutang(a, b): Observable<any> {
    return this.http.get(apiurx + 'master/listbayarpiutang.php?kdcabang=' + a + '&notrans=' + b)
  }

  stokobat(a, b): Observable<any> {
    return this.http.get(apiurx + 'transaksi/stokobat.php?kdcabang=' + a + '&kdobat=' + b)
  }
  listbayarpiutangh(a, b, c, d): Observable<any> {
    return this.http.get(apiurx + 'master/listbayarpiutangh.php?kdcabang=' + a + '&sts=' + b + '&nama=' + c + '&tgl=' + d)
  }



  listhutang(a, b, c, d, e, f, g): Observable<any> {
    return this.http.get(apiurx + 'master/listhutang.php?kdcabang=' + a + '&kdsup=' + b + '&tgldari=' + c + '&tglsampai=' + d + '&nama=' + e + '&verif=' + f + '&cariby=' + e)
  }


  listhutangall(a, c, d, e): Observable<any> {
    return this.http.get(apiurx + 'master/listhutangall.php?kdcabang=' + a + '&nama=' + c + '&verif=' + d + '&cariby=' + e)
  }


  coax(a, b): Observable<any> {
    return this.http.get(apiurx + 'transaksi/coa.php?kdcabang=' + a + '&nama=' + b)
  }
  coad(a, b): Observable<any> {
    return this.http.get(apiurx + 'transaksi/coad.php?kdcabang=' + a + '&kdgl=' + b)
  }

  coadbawah(a, b): Observable<any> {
    return this.http.get(apiurx + 'transaksi/coadbawah.php?kdcabang=' + a + '&kdgl=' + b)
  }
  ...
  listgl(a, b, c): Observable<any> {
    return this.http.get(apiurx + 'transaksi/listgl.php?kdcabang=' + a + '&nama=' + b + '&tgl=' + c)
  }
  ...
  getpendaftaranprovider(tgl,nourut): Observable<any> {
    return this.http.get(apiurx + 'pcare/getpendaftaranprovider.php?tgl=' + tgl+'&nourut='+nourut)
  }

  pendaftaranbynourut(tgl,b): Observable<any> {
    return this.http.get(apiurx + 'pcare/pendaftaranbynourut.php?tgl=' + tgl+'&nourut='+b)
  }
  ...
  refrujukankusus(status, kdkhusus, tgl, kdsubsp, nokartu): Observable<any> {
    return this.http.get(apiurx + 'pcare/refrujukankusus.php?status=' + status + '&kdkhusus=' + kdkhusus + '&tgl=' + tgl + '&kdsubsp=' + kdsubsp + '&nokartu=' + nokartu)
  }
  ...
  alergi(norm, kdcabang): Observable<any> {
    return this.http.get(apiurx + 'transaksi/alergi.php?norm=' + norm + '&kdcabang=' + kdcabang)
  }
  ...
  listpasienmobile(tgl, kdcabang, sts, pasien): Observable<any> {
    return this.http.get(apiurx + 'master/listpasienmobile.php?tgl=' + tgl + '&kdcabang=' + kdcabang + '&sts=' + sts + '&pasien=' + pasien)
  }

  bpjsdashbord(bulan, tahun, waktu): Observable<any> {
    return this.http.get('https://clenicapp.com/rjx/ws_antrianbpjs/dashboardbulan.php?bulan=' + bulan + '&tahun=' + tahun + '&waktu=' + waktu)
  }
  ...
  listkostumer(a, b): Observable<any> {
    return this.http.get(apiurx + 'transaksi/listkostumer.php?kdcabang=' + a + '&nama=' + b)
  }
  ...
  pasiendaftar(a, b, c): Observable<any> {
    return this.http.get(apiurx + 'transaksi/pasiendaftar.php?kdcabang=' + a + '&nama=' + b + '&kdpoli=' + c)
  }
  ...
  riwayatpriksa(a, b): Observable<any> {
    return this.http.get(apiurx + 'transaksi/riwayatpriksa.php?kdcabang=' + a + '&norm=' + b)
  }
  ...
  listadjust(a, b, c): Observable<any> {
    return this.http.get(apiurx + 'transaksi/listadjust.php?kdcabang=' + a + '&tgl=' + b + '&nama=' + c)
  }
  listadjustd(a, b): Observable<any> {
    return this.http.get(apiurx + 'transaksi/listadjustd.php?kdcabang=' + a + '&noadjust=' + b)
  }
  ...
  tampilcoa(a, b): Observable<any> {
    return this.http.get(apiurx + 'master/tampilcoa.php?kdcabang=' + a + '&coa=' + b)
  }
  ...
  dokterspesialis(a, b): Observable<any> {
    return this.http.get(apiurx + 'master/dokterspesialis.php?kdcabang=' + a + '&kdspesialis=' + b)
  }
  kamar(a, b): Observable<any> {
    return this.http.get(apiurx + 'master/kamar.php?kdcabang=' + a + '&kdkelas=' + b)
  }

  listpasienri(a, b): Observable<any> {
    return this.http.get(apiurx + 'master/listpasienri.php?kdcabang=' + a + '&nama=' + b)
  }
  ...
  tampilrujukan(a, b): Observable<any> {
    return this.http.get(apiurx + 'transaksi/tampilrujukan.php?kdcabang=' + a + '&notrans=' + b)
  }

  listkomponen(a, b): Observable<any> {
    return this.http.get(apiurx + 'transaksi/listkomponen.php?kdcabang=' + a + '&kdtarif=' + b)
  }

  listkomponendokter(a, b): Observable<any> {
    return this.http.get(apiurx + 'transaksi/listkomponendokter.php?kdcabang=' + a + '&kdtarif=' + b)
  }
  tarifmri(a, b): Observable<any> {
    return this.http.get(apiurx + 'master/treeview.php?kdcabang=' + a + '&kdtarif=' + b)
  }

  rwtobat(a, b): Observable<any> {
    return this.http.get(apiurx + 'master/rwtobat.php?kdcabang=' + a + '&norm=' + b)
  }
  rwtobatd(a, b, notransaksi): Observable<any> {
    return this.http.get(apiurx + 'master/rwtobatd.php?kdcabang=' + a + '&norm=' + b + '&notransaksi=' + notransaksi)
  }
  ...
  frekuensiobat(a, b): Observable<any> {
    return this.http.get(apiurx + 'master/frekuensiobat.php?kdcp=' + a + '&kdbs=' + b)
  }
  ...
  jmlobathari(a, b): Observable<any> {
    return this.http.get(apiurx + 'master/jmlobathari.php?kdcp=' + a + '&kdbs=' + b)
  }

  obatermbyid(a, b): Observable<any> {
    return this.http.get(apiurx + 'master/obatermbyid.php?kdcabang=' + a + '&kdobat=' + b)
  }
  ...
  cekpasienlamadanbaru(a, b): Observable<any> {
    return this.http.get(apiurx + 'transaksi/cekpasienlamadanbaru.php?norm=' + a + '&kdcabang=' + b)
  ...
  getFiles() {
    return this.http.get<any>(apiurx + 'master/treeview.php').toPromise().then((res) => <TreeNode[]>res);
  }


  getlabtree(a, b) {
    return this.http.get<any>(apiurx + 'master/listtariftree.php?status=' + a + '&kdcabang=' + b).toPromise().then((res) => <TreeNode[]>res);
  }
  // listcoa(b) {
  ...
  cekpasien(a, b, c): Observable<any> {
    ...
    return this.http.get(apiurx + 'master/cekpasien.php?no=' + a + '&kdcabang=' + b + '&sts=' + c)
  ...
  editlokasiss(data: any, heder: any, id: any): Observable<any> {
    return this.http.put(satusehat + 'Location/' + id, data, { headers: heder })
  }
  ...
  getpasien(a, heder): Observable<any> {
    ...
    return this.http.get(satusehat + 'Patient?identifier=https://fhir.kemkes.go.id/id/nik|' + a, { headers: heder })
  ...
  tampilkajianresep(a): Observable<any> {
    return this.http.get(apiurx + 'transaksi/tampilkajianresep.php?noresep=' + a)
  }
  polibyid(a, b): Observable<any> {
    return this.http.get(apiurx + 'master/polibyid.php?kdcabang=' + a + '&kdpoli=' + b)
  }
  ...
  riwayattriase(data, status): Observable<any> {
    return this.http.get(apiurx + 'emr/riwayattriase.php?data=' + data + '&status=' + status)
  }

  rwttindakan(data, status): Observable<any> {
    return this.http.get(apiurx + 'emr/rwttindakan.php?data=' + data + '&status=' + status)
  }
  rwtkajianawal(data, status): Observable<any> {
    return this.http.get(apiurx + 'emr/rwtkajianawal.php?data=' + data + '&status=' + status)
  }
  rwtaskep(data, status): Observable<any> {
    return this.http.get(apiurx + 'emr/rwtaskep.php?data=' + data + '&status=' + status)
  }
